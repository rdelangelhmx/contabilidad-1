...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCompChequeAll))
      ...
      Me.cdmMain.Id = New System.Guid("20f65742-29b2-4f84-92c9-393eda7284bd")
      ...
      Me.Name = "frmCompChequeAll"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Cheques de Bancos"
...
#End Region
   ...
   Private Sub frmCompChequeAll_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCompChequeAll_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moCompCheque
            .SelectFilter = clsCompCheque.SelectFilters.GridAll
            .WhereFilter = clsCompCheque.WhereFilters.GridAll
            .OrderByFilter = clsCompCheque.OrderByFilters.GridAll
            .EmpresaId = mlngEmpresaId
            .GestionId = clsAppInfo.GestionId
            .ChequeId = mlngChequeId
            .PlanId = mlngPlanId
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oCompCheque.GestionId = ToLong(clsAppInfo.GestionId)
            oCompCheque.CompId = 0
            oCompCheque.CompDetId = 0
            oCompCheque.PlanId = mlngPlanId
            oCompCheque.ChequeId = mlngChequeId
            oCompCheque.Fecha = ConvertDMY(ToDate(Now))
            oCompCheque.ChequeMonto = 0
            oCompCheque.EstadoIdCob = 12
            oCompCheque.EstadoId = 11

            If (mlngPlanId = 0) Then
               If (grdMain.RowCount > 0) Then
                  If (grdMain.GetValue("ChequeId") > 0) Then
                     oCompCheque.PlanId = grdMain.GetValue("PlanId")
                  End If
               Else
                  MessageBox.Show("Debe Seleccionar un Registro con chequera Válida", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
               End If
            End If
            If oCompCheque.PlanId > 0 Then
               .DataObject = oCompCheque
               .ShowDialog()
   ...
   Private Sub DataEdit()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If (ToLong(grdMain.GetValue("CompChequeId")) > 0) Then
               If (ToLong(grdMain.GetValue("EstadoId")) <> clsEstado.ANULADO) Then
                  With oCompCheque
                     .CompChequeId = ToLong(grdMain.GetValue("CompChequeId"))
                  ...
                  End With
               Else
                  MessageBox.Show("Imposible Editar el cheque", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
               End If
            Else
   ...
   Private Sub CloneVM(ByRef oVM As clsCompChequeVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            .CompChequeId = ToLong(grdMain.GetValue("CompChequeId"))
            .ChequeNro = ToStr(grdMain.GetValue("ChequeNro"))
            .BancoDes = ToStr(grdMain.GetValue("BancoDes"))
            .ChequeraNro = ToStr(grdMain.GetValue("ChequeDetNro"))
            ...
            If (ToLong(grdMain.GetValue("CompChequeId")) > 0) Then
               If (ToLong(grdMain.GetValue("CompId")) = 0) Then
                  If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                     With oCompCheque
                        .WhereFilter = clsCompCheque.WhereFilters.PrimaryKey
                        .CompChequeId = ToLong(grdMain.GetValue("CompChequeId"))
                  ...
                  End If
               Else
                  MessageBox.Show("Imposible Eliminar Cheque de Comprobante", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
               End If
            Else
               MessageBox.Show("Debe Seleccionar un Registro", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If
   ...
   Private Sub PrintReport()
      Dim rpt As New rptCompChequeAll

      rpt.DataSource = GetDataView(moCompCheque.DataSet.Tables(moCompCheque.TableName))

      rpt.lblTitle.Text = "Cheques"
      rpt.Document.Name = "Cheques"
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         .RootTable.Columns("PlanCta").Caption = "Cuenta Cont."
         ...
         .RootTable.Columns("BancoDes").Width = 100
         ...
         .RootTable.Columns("ChequeDetNro").Caption = "Nro Chequera"
         .RootTable.Columns("ChequeDetNro").Width = 90
         ...
         .RootTable.Columns("EstadoIdCob").Visible = False

         .RootTable.Columns("EstadoDesCob").Caption = "Estado Cheque"
         .RootTable.Columns("EstadoDesCob").Width = 95
         .RootTable.Columns("EstadoDesCob").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("EstadoDesCob").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("ChequeDes").Caption = "A la Orden De"
         .RootTable.Columns("ChequeDes").Width = 100
         ...
         .RootTable.Columns("ChequeMonto").Caption = "Monto"
         .RootTable.Columns("ChequeMonto").FormatString = DecimalMask()
         .RootTable.Columns("ChequeMonto").Width = 80
         .RootTable.Columns("ChequeMonto").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
         .RootTable.Columns("ChequeMonto").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         ...
         .RootTable.Columns("EstadoDes").Caption = "Estado Comp."
         .RootTable.Columns("EstadoDes").Width = 90
   ...
   Private Sub AddConditionalFormatting()
      ...
      fc = New Janus.Windows.GridEX.GridEXFormatCondition(grdMain.RootTable.Columns("EstadoIdCob"), Janus.Windows.GridEX.ConditionOperator.Equal, 13)
      fc.FormatStyle.ForeColor = Color.DarkOrange
      grdMain.RootTable.FormatConditions.Add(fc)

      fc = New Janus.Windows.GridEX.GridEXFormatCondition(grdMain.RootTable.Columns("EstadoIdCob"), Janus.Windows.GridEX.ConditionOperator.Equal, 12)
   ...
   Private Sub frmCompChequeAll_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCompChequeAll_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
