Public Class frmLibroDiarioDet
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmLibroDiarioDet))
      ...
      Me.KeyPreview = True
      Me.Name = "frmLibroDiarioDet"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Detalle de Libro Diario"
...
#End Region
   ...
   Private Sub frmLibroDiarioDet_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmLibroDiarioDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub PrintReport()
      Dim rpt As New rptLibroDiarioDet

      rpt.DataSource = GetDataView(moDataTable.DataSet.Tables(moComp.TableName))

      rpt.lblTitle.Text = "Detalle de Libro Diario"
      rpt.Document.Name = "Detalle de Libro Diario"
   ...
   Private Sub frmLibroDiarioDet_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmLibroDiarioDet_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moComp.Dispose()
      Call ClearMemory()
   End Sub
...
#Region " DataSet-LibroDiario "
   ...
   Private Function GetRow(ByVal oDataRow As DataRow, ByVal oRowComp As DataRow) As DataRow
      Dim oRow As DataRow
      oRow = moDataTable.NewRow

      oRow("Fecha") = oRowComp("Fecha")
      oRow("TipoCompId") = oRowComp("TipoCompId")
      oRow("TipoCompDes") = oRowComp("TipoCompDes")
      oRow("CompNro") = oRowComp("CompNro")
      oRow("EstadoId") = oRowComp("EstadoId")
      oRow("EstadoDes") = oRowComp("EstadoDes")
...
#Region " Grid-LibroDiario "
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Detalle de Libro Diario"
         ...
         .RootTable.Columns("TipoCompDes").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         ...
         .RootTable.Columns("CompNro").Width = 70
      ...
      Try
         ...
         With moComp
            ...
            If mboolAsientoAnulado Then
               .WhereFilter = clsComp.WhereFilters.LibroDiarioAnulado
            Else
            ...
            If .Open() Then
               Do While intRow < .DataSet.Tables(.TableName).Rows.Count
                  ...
                  Dim oRowComp As DataRow = .DataSet.Tables(.TableName).Rows(intRow)
                  moDataTable.Rows.Add(GetHeaderDetalle(oRowComp))
                  With oCompDet
                     ...
                     If .Open() Then
                        ...
                        Do While intRowDet < .DataSet.Tables(.TableName).Rows.Count
                           moDataTable.Rows.Add(GetRow(.DataSet.Tables(.TableName).Rows(intRowDet), oRowComp))
                           intRowDet += 1
                        Loop
                     End If
                  End With
