Public Class frmSumaSaldoComparativoCCFind
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmSumaSaldoComparativoCCFind))
      ...
      Me.ExplorerBarContainerControl4.Size = New System.Drawing.Size(773, 259)
      ...
      Me.grdMain.Size = New System.Drawing.Size(773, 259)
      ...
      Me.bcgMain.Size = New System.Drawing.Size(797, 437)
      ...
      Me.grpEmpresa.Controls.Add(Me.cboCentroCosto)
      Me.grpEmpresa.Controls.Add(Me.Label6)
      Me.grpEmpresa.Location = New System.Drawing.Point(4, 4)
      Me.grpEmpresa.Name = "grpEmpresa"
      Me.grpEmpresa.Size = New System.Drawing.Size(788, 40)
      Me.grpEmpresa.TabIndex = 13
      Me.grpEmpresa.VisualStyle = Janus.Windows.UI.Dock.PanelVisualStyle.Office2007
      '
      'cboCentroCosto
      '
      Me.cboCentroCosto.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
                  Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
      Me.cboCentroCosto.ComboStyle = Janus.Windows.GridEX.ComboStyle.DropDownList
      ...
      Me.cboCentroCosto.DropDownButtonsVisible = False
      Me.cboCentroCosto.ForeColor = System.Drawing.SystemColors.HotTrack
      Me.cboCentroCosto.Location = New System.Drawing.Point(124, 12)
      Me.cboCentroCosto.Name = "cboCentroCosto"
      Me.cboCentroCosto.SaveSettings = False
      Me.cboCentroCosto.Size = New System.Drawing.Size(656, 20)
      ...
      Me.Label6.Text = "Centros de Costos"
      '
      'grbFac
      '
      ...
      Me.grbFac.Location = New System.Drawing.Point(652, 348)
      ...
      ExplorerBarGroup1.ContainerHeight = 260
      ...
      Me.ebrMain.Size = New System.Drawing.Size(789, 292)
      ...
      Me.UiGroupBox3.Location = New System.Drawing.Point(201, 346)
      Me.UiGroupBox3.Name = "UiGroupBox3"
      Me.UiGroupBox3.Size = New System.Drawing.Size(251, 86)
      ...
      Me.cboTipoAsiento.Location = New System.Drawing.Point(104, 14)
      ...
      Me.cboMoneda.Location = New System.Drawing.Point(104, 38)
      ...
      Me.chkFecha.Location = New System.Drawing.Point(16, 342)
      ...
      Me.grpMain.Location = New System.Drawing.Point(8, 346)
      Me.grpMain.Name = "grpMain"
      Me.grpMain.Size = New System.Drawing.Size(188, 86)
      ...
      Me.UiGroupBox2.Location = New System.Drawing.Point(456, 346)
      Me.UiGroupBox2.Name = "UiGroupBox2"
      Me.UiGroupBox2.Size = New System.Drawing.Size(188, 86)
      ...
      Me.chkSaldoCero.Location = New System.Drawing.Point(5, 52)
      Me.chkSaldoCero.Name = "chkSaldoCero"
      Me.chkSaldoCero.Size = New System.Drawing.Size(177, 16)
      ...
      Me.chkSaldoAnterior.Size = New System.Drawing.Size(176, 16)
      ...
      Me.chkUltimoPeriodo.Location = New System.Drawing.Point(5, 32)
      Me.chkUltimoPeriodo.Name = "chkUltimoPeriodo"
      Me.chkUltimoPeriodo.Size = New System.Drawing.Size(177, 16)
      ...
      Me.KeyPreview = True
      Me.Name = "frmSumaSaldoComparativoCCFind"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Criterios Balance de Sumas y Saldos Comparativo por Centro de Costo"
...
#End Region
   ...
   Private Sub frmSumaSaldoComparativoCCFind_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmSumaSaldoComparativoCCFind_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
...
#Region " ComboLoads "
   ...
   Private Sub cboCentroCostoLoad()
      Dim oDataTable = New DataTable("cboEmpresa")

      oDataTable.Columns.Add("Orden", Type.GetType("System.Int32"))
      oDataTable.Columns.Add("CentroCostoId", Type.GetType("System.Int32"))
      oDataTable.Columns.Add("CentroCostoCod", Type.GetType("System.String"))
      oDataTable.Columns.Add("CentroCostoDes", Type.GetType("System.String"))
         ...
         With oCentroCosto
            ...
            If .Open() Then
               With cboCentroCosto
                  ...
                  .DropDownList.Columns("Orden").Visible = False
                  ...
                  .DropDownList.Columns("CentroCostoCod").Width = 80

                  .DropDownList.Columns("CentroCostoDes").Caption = "Descripción"
                  .DropDownList.Columns("CentroCostoDes").DataMember = "CentroCostoDes"
                  .DropDownList.Columns("CentroCostoDes").Width = 500
               End With

               For Each orow In .DataSet.Tables(.TableName).Rows
                  Dim row As DataRow = oDataTable.NewRow
                  row("Orden") = 0
                  row("CentroCostoId") = orow("CentroCostoId")
                  row("CentroCostoCod") = orow("CentroCostoCod")
                  row("CentroCostoDes") = orow("CentroCostoDes")
...
#End Region
   ...
   Private Sub frmSumaSaldoComparativoCCFind_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Function FormCheck() As Boolean
      ...
      If cboCentroCosto.DropDownList.GetCheckedRows.Count <= 1 Then
         strMessage &= "Debe Seleccionar mas de un Centro de Costo." & vbCrLf
      End If
   ...
   Private Sub frmSumaSaldoLoad()
      If FormCheck() Then
         ...
         Dim oListaCC As New List(Of Long)
         ...
         For Each Row In cboCentroCosto.DropDownList.GetCheckedRows
            oListaCC.Add(ToLong(Row.Cells("CentroCostoId").Value))
         Next

         Dim frm As New frmSumaSaldoComparativoCC
   ...
   Private Sub frmSumaSaldoComparativoCCFind_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moPlan.Dispose()
      Call ClearMemory()
   End Sub
