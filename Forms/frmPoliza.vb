...
#End Region
   ...
   Private Sub frmPoliza_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
   ...
   Private Sub grdMainLoad()
      Try
         With moPoliza
            .SelectFilter = clsPoliza.SelectFilters.Grid
            .WhereFilter = clsPoliza.WhereFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If grdMain.RowCount > 0 And ToLong(grdMain.GetValue("PolizaId")) > 0 Then
            With oPoliza
               .PolizaId = ToLong(grdMain.GetValue("PolizaId"))
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oPoliza.EmpresaId = mlngEmpresaId
            oPoliza.GestionId = clsAppInfo.GestionId
            oPoliza.CompId = 0
            oPoliza.EstadoId = 11
      ...
      Try
         If grdMain.RowCount > 0 Then
            If ToLong(grdMain.GetValue("CompId")) = 0 Then
               ...
               End With
            Else
               MessageBox.Show("Imposible Editar la Poliza ya que Viene de un Comprobante", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If
         Else
   ...
   Private Sub CloneVM(ByRef oVM As clsPolizaVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            .PolizaId = ToLong(grdMain.GetValue("PolizaId"))
            .PolizaNro = ToStr(grdMain.GetValue("PolizaNro"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If ToLong(grdMain.GetValue("CompId")) = 0 Then
               ...
               End If
            Else
               MessageBox.Show("Imposible Eliminar la Poliza ya que Viene de un Comprobante", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If
         Else
            MessageBox.Show("Debe Seleccionar un Registro", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
         End If
   ...
   Private Sub PrintReport()
      Dim rpt As New rptPoliza

      rpt.DataSource = GetDataView(moPoliza.DataSet.Tables(moPoliza.TableName))

      rpt.lblTitle.Text = "Polizas"
      rpt.Document.Name = "Polizas"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("PolizaId")
   ...
   Private Sub frmPoliza_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmPoliza_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moPoliza.Dispose()
      Call ClearMemory()
   End Sub
End Class
