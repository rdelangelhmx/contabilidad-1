Public Class frmTipoActEco
   Inherits System.Windows.Forms.Form

   Private moTipoActEco As clsTipoActEco
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmTipoActEco))
...
#End Region
   ...
   Private Sub frmTipoActEco_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmTipoActEco_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moTipoActEco
            .SelectFilter = clsTipoActEco.SelectFilters.Grid
            .WhereFilter = clsTipoActEco.WhereFilters.Grid
            .OrderByFilter = clsTipoActEco.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("TipoActEcoId")) > 0) Then
            With oTipoActEco
               .TipoActEcoId = ToLong(grdMain.GetValue("TipoActEcoId"))
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oTipoActEco.EmpresaId = mlngEmpresaId
   ...
   Private Sub CloneVM(ByRef oVM As clsTipoActEcoVM)
      If clsAppInfo.RegistrarBitacora Then
         oVM = New clsTipoActEcoVM

         With oVM
            .TipoActEcoId = ToLong(grdMain.GetValue("TipoActEcoId"))
            .TipoActEcoDes = ToStr(grdMain.GetValue("TipoActEcoDes"))
   ...
   Private Sub DataDelete()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If Not DosificaDetFind(ToLong(grdMain.GetValue("TipoActEcoId"))) Then
               If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                  With oTipoActEco
                     .WhereFilter = clsTipoActEco.WhereFilters.PrimaryKey
                     .TipoActEcoId = ToLong(grdMain.GetValue("TipoActEcoId"))
               ...
               End If
            Else
               MessageBox.Show("Imposible Eliminar El Registro, Debido a que ya Tiene Uno o Mas Datos Técnicos", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If
         Else
            MessageBox.Show("Debe Seleccionar un Registro", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
         End If
   ...
   Private Function DosificaDetFind(ByVal lngTipoActEcoId As Long) As Boolean
      Dim oDosificaDet As New clsDosificaDet(clsAppInfo.ConnectString)

      Try
         With oDosificaDet
            .SelectFilter = clsDosificaDet.SelectFilters.ListBox
            .WhereFilter = clsDosificaDet.WhereFilters.TipoActEcoId
            .EmpresaId = mlngEmpresaId
            .TipoActEcoId = lngTipoActEcoId
   ...
   Private Sub PrintReport()
      'Dim rpt As New rptTipoActEco

      'rpt.DataSource = GetDataView(moTipoActEco.DataSet.Tables(moTipoActEco.TableName))

      'rpt.lblTitle.Text = "Tipos de Datos Técnicos"
      'rpt.Document.Name = "Tipos de Datos Técnicos"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("TipoActEcoId")
   ...
   Private Sub FormInit()
      ...
      moTipoActEco = New clsTipoActEco(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Actividades Económicas"
         .ContextMenu = mnuMain
         ...
         .RootTable.Columns("TipoActEcoDes").Width = 500
   ...
   Private Sub frmTipoActEco_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmTipoActEco_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moTipoActEco.Dispose()
      Call ClearMemory()
   End Sub
