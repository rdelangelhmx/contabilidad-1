Public Class frmLibroMayorDetFind
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmLibroMayorDetFind))
      ...
      Me.ExplorerBarContainerControl4.Size = New System.Drawing.Size(865, 297)
      ...
      Me.grdMain.Size = New System.Drawing.Size(865, 297)
      ...
      Me.bcgMain.Size = New System.Drawing.Size(889, 414)
      ...
      Me.ebrMain.Size = New System.Drawing.Size(881, 330)
      ...
      Me.grbFac.Location = New System.Drawing.Point(452, 338)
      Me.grbFac.Name = "grbFac"
      Me.grbFac.Size = New System.Drawing.Size(84, 32)
      Me.grbFac.TabIndex = 6
      ...
      Me.optSinFac.Location = New System.Drawing.Point(4, 12)
      ...
      Me.UiGroupBox2.Location = New System.Drawing.Point(200, 338)
      Me.UiGroupBox2.Name = "UiGroupBox2"
      Me.UiGroupBox2.Size = New System.Drawing.Size(248, 74)
      ...
      Me.cboMoneda.Location = New System.Drawing.Point(88, 24)
      ...
      Me.cboTipoAsiento.Location = New System.Drawing.Point(88, 48)
...
#End Region
   ...
   Private Sub frmLibroMayorDetFind_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmLibroMayorDetFind_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub cboMonedaLoad()
      ...
      Try
         With oMoneda
            ...
            If .Open() Then
               oItem = New clsListItem(0, "Por Comprobante")
...
#End Region
      ...
      If oLista.Count Then
         ...
         If cboMoneda.SelectedIndex <> -1 Then
            If oListaTipoAsiento.Count Then
               Dim frm As New frmLibroMayorDet
   ...
   Private Sub frmLibroMayorDetFind_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmLibroMayorDetFind_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moPlan.Dispose()
      Call ClearMemory()
   End Sub
...
#End Region
   ...
   Public Overrides Function ToString() As String
      ...
      For Each oRow As Janus.Windows.GridEX.GridEXRow In grdMain.GetCheckedRows
         strPlanDes &= ToStr(oRow.Cells("PlanDes").Value) & ", "
      Next

      Return "Gestión: " & clsAppInfo.Gestion & If(chkFecha.Checked, "; Desde " & dtpFechaIni.Text & " Hasta " & dtpFechaFin.Text, "") & "; Tipo Asiento: " & cboTipoAsiento.Text & "; Moneda: " & cboMoneda.Text & "; Cuentas: " & strPlanDes
   End Function
End Class
