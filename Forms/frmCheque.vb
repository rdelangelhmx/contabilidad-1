...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.cdmMain.Id = New System.Guid("01e223a3-2d3e-4d3e-b123-e42a81ed39ec")
...
#End Region
   ...
   Private Sub frmCheque_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("ChequeId")) > 0) Then
            With oCheque
               .ChequeId = ToLong(grdMain.GetValue("ChequeId"))

               If .FindByPK Then
                  Dim frm As New frmChequeEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oCheque
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oCheque.EmpresaId = mlngEmpresaId
   ...
   Private Sub DataEdit()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If (ToLong(grdMain.GetValue("ChequeId")) > 0) Then
               With oCheque
                  .ChequeId = ToLong(grdMain.GetValue("ChequeId"))
   ...
   Private Sub CloneVM(ByRef oVM As clsChequeVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            ...
            .BancoCta = ToStr(grdMain.GetValue("BancoCta"))
   ...
   Private Sub DataDelete()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If (ToLong(grdMain.GetValue("ChequeId")) > 0) Then
               If Not isCompChequeFind(ToLong(grdMain.GetValue("ChequeId"))) Then
                  If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                     With oCheque
                        ...
                        If .IsDeleted Then
                           ...
                           If .Delete Then
                              .CloseConection()
                              Call ChequeDetDelete(.ChequeId)
                              Call ChequeImpDelete(.ChequeId)
                              Call grdMainLoad()
                           End If
                        Else
   ...
   Private Function isCompChequeFind(ByVal lngChequeId As Long) As Boolean
      Dim oCompCheque As New clsCompCheque(clsAppInfo.ConnectString)

      Try
         With oCompCheque
            .SelectFilter = clsCompCheque.SelectFilters.All
            .WhereFilter = clsCompCheque.WhereFilters.ChequeId
            .EmpresaId = mlngEmpresaId
   ...
   Private Function ChequeDetDelete(ByVal lngChequeId As Long) As Boolean
   ...
   Private Function ChequeImpDelete(ByVal lngChequeId As Long) As Boolean
   ...
   Private Sub PrintReport()
      Dim rpt As New rptCheque

      rpt.DataSource = GetDataView(moCheque.DataSet.Tables(moCheque.TableName))

      rpt.lblTitle.Text = "Chequeras"
      rpt.Document.Name = "Chequeras"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("ChequeId")
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         .RootTable.Columns("BancoCta").Caption = "Nro Cuenta"
   ...
   Private Sub frmCheque_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCheque_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moCheque.Dispose()
      Call ClearMemory()
   End Sub
