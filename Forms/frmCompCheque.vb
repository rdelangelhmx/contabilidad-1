...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCompCheque))
      ...
      Me.Name = "frmCompCheque"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Cheques del Comprobante"
...
#End Region
   ...
   Private Sub frmCompCheque_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCompCheque_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moCompCheque
            .SelectFilter = clsCompCheque.SelectFilters.Grid
            .WhereFilter = clsCompCheque.WhereFilters.Grid
            .OrderByFilter = clsCompCheque.OrderByFilters.Grid
         ...
         If grdMain.RowCount > 0 Then
            If (ToLong(grdMain.GetValue("CompChequeId")) > 0) Then
               If (ToLong(grdMain.GetValue("EstadoId")) <> clsEstado.ANULADO) Then
                  ...
                  End With
               Else
                  MessageBox.Show("Imposible Editar la Venta", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
               End If
            Else
   ...
   Private Sub CloneVM(ByRef oVM As clsCompChequeVM)
      If clsAppInfo.RegistrarBitacora And Not mboolNuevoComprobante Then
         ...
         With oVM
            ...
            .ChequeDetId = ToStr(grdMain.GetValue("ChequeDetId"))
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         .RootTable.Columns("ChequeNro").Caption = "Número"
         ...
         .RootTable.Columns("EstadoDesCob").Caption = "Cheque"
         .RootTable.Columns("EstadoDesCob").Width = 80
   ...
   Private Sub frmCompCheque_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCompCheque_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
