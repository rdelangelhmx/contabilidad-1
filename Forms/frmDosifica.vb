...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmDosifica))
      ...
      Me.ilsMain.Images.SetKeyName(7, "Copy.ico")
      '
      'cdmMain
      '
      ...
      Me.cdmMain.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New2, Me.Edit, Me.Delete, Me.ViewAll, Me.Print, Me.Exit2, Me.Refrescar, Me.Duplicate})
      Me.cdmMain.ContainerControl = Me
      Me.cdmMain.Id = New System.Guid("c7b04c73-f5b8-4b11-8456-0f73e16ac05d")
      ...
      Me.UiCommandBar1.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New1, Me.Separator1, Me.Edit1, Me.Separator2, Me.Delete1, Me.Separator6, Me.Duplicate1, Me.Separator7, Me.Refrescar1, Me.Separator3, Me.ViewAll1, Me.Separator4, Me.Print1, Me.Separator5, Me.Exit1})
      Me.UiCommandBar1.Key = "tbrMain"
      Me.UiCommandBar1.Location = New System.Drawing.Point(0, 0)
      Me.UiCommandBar1.Name = "UiCommandBar1"
      Me.UiCommandBar1.RowIndex = 0
      Me.UiCommandBar1.Size = New System.Drawing.Size(621, 28)
...
#End Region
   ...
   Private Sub frmDosifica_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmDosifica_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moDosifica
            .SelectFilter = clsDosifica.SelectFilters.Grid
            .WhereFilter = clsDosifica.WhereFilters.Grid
            .OrderByFilter = clsDosifica.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("DosificaId")) > 0) Then
            With oDosifica
               .DosificaId = ToLong(grdMain.GetValue("DosificaId"))

               If .FindByPK Then
                  Dim frm As New frmDosificaEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oDosifica
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oDosifica.EmpresaId = mlngEmpresaId
            oDosifica.EstadoId = 11

            .DataObject = oDosifica
            .ShowDialog()
   ...
   Private Sub DataEdit()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If (ToLong(grdMain.GetValue("DosificaId")) > 0) Then

               If isFacturaFind(ToLong(grdMain.GetValue("DosificaId"))) Then
                  If MessageBox.Show("La Dosificacion tiene Facturas emitidas " & vbCrLf & "¿Realmente desea continuar con la Edición?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.No Then
                     Exit Sub
                  End If
               End If
   ...
   Private Sub CloneVM(ByRef oVM As clsDosificaVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            ...
            .TipoDosificaId = ToLong(grdMain.GetValue("TipoDosificaId"))
            .TipoDosificaDes = ToStr(grdMain.GetValue("TipoDosificaDes"))
   ...
   Private Sub DataDelete()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If (ToLong(grdMain.GetValue("DosificaId")) > 0) Then
               If Not isFacturaFind(ToLong(grdMain.GetValue("DosificaId"))) Then

                  If MessageBox.Show("¿Realmente quiere eliminar el Dosifica?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                     With oDosifica
                        .WhereFilter = clsDosifica.WhereFilters.PrimaryKey
                        .DosificaId = ToLong(grdMain.GetValue("DosificaId"))
                        If .IsDeleted Then
                           ...
                           If .Delete Then
                              .CloseConection()
                              Call DosificaDetDelete(.DosificaId)
                              Call grdMainLoad()
                           End If
                        Else
                  ...
                  End If
               Else
                  MessageBox.Show("Imposible eliminar la Dosificación", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
               End If
            Else
               MessageBox.Show("Debe Seleccionar un Registro", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If
   ...
   Private Function isFacturaFind(ByVal lngDosificaId As Long) As Boolean
      Dim oFactura As New clsFactura(clsAppInfo.ConnectString)

      Try
         With oFactura
            .SelectFilter = clsFactura.SelectFilters.All
            .WhereFilter = clsFactura.WhereFilters.DosificaId
            .EmpresaId = mlngEmpresaId
   ...
   Private Function DosificaDelete(ByVal lngDosificaId As Long) As Boolean
      Dim oDosifica As New clsDosifica(clsAppInfo.ConnectString)

      DosificaDelete = False
      ...
      Try
         With oDosifica
            ...
            If .FindByPK Then
               Call DosificaDetDelete(lngDosificaId)
               Return .Delete
            End If
         End With
   ...
   Private Function DosificaDetDelete(ByVal lngDosificaId As Long) As Boolean
      Dim oDosificaDet As New clsDosificaDet(clsAppInfo.ConnectString)

      Try
         With oDosificaDet
            .WhereFilter = clsDosificaDet.WhereFilters.DosificaId
            .EmpresaId = mlngEmpresaId
            .DosificaId = lngDosificaId
            Return .Delete
         End With
   ...
   Private Sub PrintReport()
      'Dim rpt As New rptDosifica

      'rpt.DataSource = GetDataView(moDosifica.DataSet.Tables(moDosifica.TableName))

      'rpt.lblTitle.Text = "Listado de Dosificas"
      'rpt.Document.Name = "Listado de Dosificas"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("DosificaId")
   ...
   Private Sub FormInit()
      ...
      moDosifica = New clsDosifica(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Dosificasiones"
         .ContextMenu = mnuMain
         ...
         .RootTable.Columns("DosificaVentaId").Visible = False

         .RootTable.Columns("DosificaVentaDes").Caption = "Dosificación"
         .RootTable.Columns("DosificaVentaDes").Width = 100
         .RootTable.Columns("DosificaVentaDes").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("DosificaVentaDes").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("TipoDosificaId").Visible = False

         .RootTable.Columns("TipoDosificaDes").Caption = "Tipo"
         .RootTable.Columns("TipoDosificaDes").Width = 100
         .RootTable.Columns("TipoDosificaDes").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("TipoDosificaDes").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         ...
         .RootTable.Columns("NumeroSFC").Caption = "SFC"
         .RootTable.Columns("NumeroSFC").Width = 100
         .RootTable.Columns("NumeroSFC").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         .RootTable.Columns("NumeroSFC").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("LlaveDosifica").Caption = "Llave Dosificación"
         .RootTable.Columns("LlaveDosifica").Width = 150
         .RootTable.Columns("LlaveDosifica").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("LlaveDosifica").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("FechaIni").Caption = "Fecha Inicial"
         ...
         .RootTable.Columns("NumeroIni").Caption = "Nro. Inicial"
         .RootTable.Columns("NumeroIni").Width = 100
         .RootTable.Columns("NumeroIni").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         .RootTable.Columns("NumeroIni").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("NumeroFin").Caption = "Nro. Final"
         .RootTable.Columns("NumeroFin").Width = 100
         .RootTable.Columns("NumeroFin").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         .RootTable.Columns("NumeroFin").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("NumeroActual").Caption = "Nro. Actual"
         .RootTable.Columns("NumeroActual").Width = 100
         .RootTable.Columns("NumeroActual").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         .RootTable.Columns("NumeroActual").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("DosificaLeyId").Visible = False

         .RootTable.Columns("DosificaLeyDes").Caption = "Mens. Leyenda"
         .RootTable.Columns("DosificaLeyDes").Width = 100
         .RootTable.Columns("DosificaLeyDes").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("DosificaLeyDes").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("ImpDosificaLey").Caption = "Imprimir Leyenda"
         .RootTable.Columns("ImpDosificaLey").Width = 50
         .RootTable.Columns("ImpDosificaLey").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         .RootTable.Columns("ImpDosificaLey").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
   ...
   Private Sub frmDosifica_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmDosifica_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moDosifica.Dispose()
      Call ClearMemory()
   End Sub
