Public Class frmCompCentroCosto
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCompCentroCosto))
      ...
      Me.cdmMain.Id = New System.Guid("e2a92b71-6e6e-4ee8-9f08-023331975755")
      ...
      Me.Name = "frmCompCentroCosto"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Centros de Costo del Comprobante"
...
#End Region
   ...
   Private Sub frmCompCentroCosto_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCompCentroCosto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moCentroCosto
            .SelectFilter = clsCentroCosto.SelectFilters.CompId
            .WhereFilter = clsCentroCosto.WhereFilters.CompId
            .OrderByFilter = clsCentroCosto.OrderByFilters.CompId
            .EmpresaId = mlngEmpresaId
            .CentroCostoId = mlngCompId
   ...
   Private Sub PrintReport()
      ...
      rpt.DataSource = GetDataView(moCentroCosto.DataSet.Tables(moCentroCosto.TableName))

      rpt.lblTitle.Text = "Centros de Costo"
      rpt.Document.Name = "Centros de Costo"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("CentroCostoId")
   ...
   Private Sub frmCompCentroCosto_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCompCentroCosto_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
