...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmPlanAdd))
      ...
      Me.Text = "Analíticos Adicionales"
...
#End Region
   ...
   Private Sub frmPlanAdd_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmPlanAdd_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moPlanAdd
            .SelectFilter = clsPlanAdd.SelectFilters.Grid
            .WhereFilter = clsPlanAdd.WhereFilters.Grid
            .OrderByFilter = clsPlanAdd.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("PlanAddId")) > 0) Then
            With oPlanAdd
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oPlanAdd.EmpresaId = mlngEmpresaId
   ...
   Private Sub CloneVM(ByRef oVM As clsPlanAddVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            ...
            .PlanAddCta = ToStr(grdMain.GetValue("PlanAddCta"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               If Not TieneCompPlanAdd(ToLong(grdMain.GetValue("PlanAddId"))) Then
                  With oPlanAdd
                     .WhereFilter = clsPlanAdd.WhereFilters.PrimaryKey
                     .PlanAddId = ToLong(grdMain.GetValue("PlanAddId"))
   ...
   Private Function TieneCompPlanAdd(ByVal lngPlanAddId As Long) As Boolean
      Dim oCompPlanAdd As New clsCompPlanAdd(clsAppInfo.ConnectString)

      Try
         TieneCompPlanAdd = True
   ...
   Private Sub PrintReport()
      Dim rpt As New rptPlanAdd

      rpt.DataSource = GetDataView(moPlanAdd.DataSet.Tables(moPlanAdd.TableName))
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         .RootTable.Columns("PlanAddCta").Caption = "Código Ana."
         ...
         .RootTable.Columns("PlanAddDes").Caption = "Descripción Analítico"
   ...
   Private Sub frmPlanAdd_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmPlanAdd_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moPlanAdd.Dispose()
      Call ClearMemory()
   End Sub
