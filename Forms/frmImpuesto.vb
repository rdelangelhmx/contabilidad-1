...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.UiCommandBar1.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New1, Me.Separator1, Me.Edit1, Me.Separator2, Me.Refrescar1, Me.Separator3, Me.ViewAll1, Me.Separator4, Me.Print1, Me.Separator5, Me.Exit1})
...
#End Region
   ...
   Private Sub grdMainLoad()
      Try
         With moImpuesto
            .SelectFilter = clsImpuesto.SelectFilters.Grid
            .OrderByFilter = clsImpuesto.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("ImpuestoId")) > 0) Then
            With oImpuesto
               .ImpuestoId = ToLong(grdMain.GetValue("ImpuestoId"))

               If .FindByPK Then
                  Dim frm As New frmImpuestoEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oImpuesto
   ...
   Private Sub CloneVM(ByRef oVM As clsImpuestoVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            .ImpuestoId = ToLong(grdMain.GetValue("ImpuestoId"))
            .ImpuestoDes = ToStr(grdMain.GetValue("ImpuestoDes"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oImpuesto
                  .WhereFilter = clsImpuesto.WhereFilters.PrimaryKey
                  .ImpuestoId = ToLong(grdMain.GetValue("ImpuestoId"))
   ...
   Private Sub PrintReport()
      'Dim rpt As New rptImpuesto

      'rpt.DataSource = GetDataView(moImpuesto.DataSet.Tables(moImpuesto.TableName))
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("ImpuestoId")
   ...
   Private Sub FormInit()
      ...
      moImpuesto = New clsImpuesto(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Impuestos"
         .ContextMenu = mnuMain

         .RootTable.Columns("ImpuestoId").Visible = False

         .RootTable.Columns("ImpuestoDes").Caption = "Impuesto"
         .RootTable.Columns("ImpuestoDes").Width = 200
         .RootTable.Columns("ImpuestoDes").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("ImpuestoDes").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("Valor").Caption = "Valor"
         .RootTable.Columns("Valor").FormatString = "##,##0.00000"
   ...
   Private Sub frmImpuesto_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmImpuesto_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moImpuesto.Dispose()
      Call ClearMemory()
   End Sub
