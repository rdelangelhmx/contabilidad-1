Public Class frmEstadoResultadoComparativoFind
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmEstadoResultadoComparativoFind))
      ...
      Me.ExplorerBarContainerControl4.Size = New System.Drawing.Size(881, 339)
      ...
      Me.grdMain.Size = New System.Drawing.Size(881, 339)
      ...
      Me.bcgMain.Size = New System.Drawing.Size(905, 491)
      ...
      Me.grpOrigen.Location = New System.Drawing.Point(200, 448)
      Me.grpOrigen.Name = "grpOrigen"
      Me.grpOrigen.Size = New System.Drawing.Size(412, 40)
      Me.grpOrigen.TabIndex = 4
      ...
      Me.UiGroupBox1.Location = New System.Drawing.Point(616, 384)
      Me.UiGroupBox1.Name = "UiGroupBox1"
      Me.UiGroupBox1.Size = New System.Drawing.Size(208, 104)
      ...
      Me.chkConsolidar.Location = New System.Drawing.Point(8, 16)
      ...
      Me.chkTotalizar.Location = New System.Drawing.Point(4, 40)
      Me.chkTotalizar.Name = "chkTotalizar"
      Me.chkTotalizar.Size = New System.Drawing.Size(196, 16)
      ...
      ExplorerBarGroup1.ContainerHeight = 340
      ...
      Me.ebrMain.Size = New System.Drawing.Size(897, 372)
      ...
      Me.chkFecha.Location = New System.Drawing.Point(16, 384)
      ...
      Me.grpMain.Controls.Add(Me.chkSaldoGestion)
      ...
      Me.grpMain.Location = New System.Drawing.Point(8, 385)
      Me.grpMain.Name = "grpMain"
      Me.grpMain.Size = New System.Drawing.Size(188, 103)
      ...
      Me.chkSaldoGestion.Enabled = False
      ...
      Me.chkSaldoGestion.Location = New System.Drawing.Point(6, 72)
      Me.chkSaldoGestion.Name = "chkSaldoGestion"
      Me.chkSaldoGestion.Size = New System.Drawing.Size(176, 16)
      Me.chkSaldoGestion.TabIndex = 3
      ...
      Me.UiGroupBox2.Location = New System.Drawing.Point(200, 384)
      Me.UiGroupBox2.Name = "UiGroupBox2"
      Me.UiGroupBox2.Size = New System.Drawing.Size(412, 64)
      ...
      Me.cboMoneda.Location = New System.Drawing.Point(87, 36)
      Me.cboMoneda.Name = "cboMoneda"
      Me.cboMoneda.SelectedItemFormatStyle.ForeColor = System.Drawing.Color.White
      Me.cboMoneda.Size = New System.Drawing.Size(145, 20)
      ...
      Me.TopRebar1.Size = New System.Drawing.Size(905, 28)
      '
      'mnuMain
      '
      ...
      '
      'frmEstadoResultadoComparativoFind
      '
      ...
      Me.KeyPreview = True
      Me.Name = "frmEstadoResultadoComparativoFind"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Criterios Estado de Resultados Comparativo"
...
#End Region
   ...
   Private Sub frmEstadoResultadoComparativoFind_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmEstadoResultadoComparativoFind_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
...
#End Region
               ...
               If oListaTipoAsiento.Count Then
                  If GridCheck() Then
                     If chkConsolidar.Checked Then
                        Dim frm As New frmEstadoResultadoConsolidado
                        With frm
                           ...
                           .FechaIni = If(chkFecha.Checked, dtpFechaIni.Value, dtpFechaIni.MinDate)
                           .FechaFin = If(chkFecha.Checked, dtpFechaFin.Value, dtpFechaIni.MaxDate)
                        ...
                        End With
                     Else
                        Dim frm As New frmEstadoResultadoComparativo
                        With frm
                           .MonedaId = ListPosition(cboMoneda, cboMoneda.SelectedIndex)
                           '.CentroCostoId = ListPosition(cboCentroCosto, cboCentroCosto.SelectedIndex)
                           '.SucursalId = ListPosition(cboSucursal, cboSucursal.SelectedIndex)
   ...
   Private Sub frmEstadoResultadoComparativoFind_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmEstadoResultadoComparativoFind_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moPlan.Dispose()
      Call ClearMemory()
   End Sub
...
#End Region
   ...
   Public Overrides Function ToString() As String
      ...
      Next
      Return If(chkFecha.Checked, " Desde " & dtpFechaIni.Text & " Hasta " & dtpFechaFin.Text & "; Incluir Saldos: " & If(chkSaldoGestion.Checked, "Sí", "No"), "") & "; Tipo Asiento: " & cboTipoAsiento.Text & "; Moneda: " & cboMoneda.Text & "; Nivel: " & dudNivel.Text & "; Centro Costo: " & cboCentroCosto.Text & "; Consolidar Empresas: " & If(chkConsolidar.Checked, "Sí", "No") & "; Totalizar Cuentas: " & If(chkTotalizar.Checked, "Sí", "No") & "; Empresas: " & strEmpresas
   End Function
