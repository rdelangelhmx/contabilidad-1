...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   Friend WithEvents Refressh As Janus.Windows.UI.CommandBars.UICommand
   Friend WithEvents Refressh1 As Janus.Windows.UI.CommandBars.UICommand
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCompParaMes))
      ...
      Me.Refressh1 = New Janus.Windows.UI.CommandBars.UICommand("Refressh")
      ...
      Me.Refressh = New Janus.Windows.UI.CommandBars.UICommand("Refressh")
      ...
      Me.cdmMain.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New2, Me.Edit, Me.Delete, Me.ViewAll, Me.Print, Me.Exit2, Me.Refressh})
      ...
      Me.UiCommandBar1.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.Edit1, Me.Separator2, Me.Refressh1, Me.Separator1, Me.ViewAll1, Me.Separator4, Me.Print1, Me.Separator5, Me.Exit1})
      ...
      'Refressh1
      '
      Me.Refressh1.Key = "Refressh"
      Me.Refressh1.Name = "Refressh1"
      '
      'Separator1
      '
      ...
      'Refressh
      '
      Me.Refressh.ImageIndex = 6
      Me.Refressh.Key = "Refressh"
      Me.Refressh.Name = "Refressh"
      Me.Refressh.Text = "Actualizar"
      '
      'LeftRebar1
      '
      ...
      Me.KeyPreview = True
      Me.Name = "frmCompParaMes"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Correlativos de Periodos"
...
#End Region
   ...
   Private Sub frmCompParaMes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCompParaMes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moCompParaMes
            .SelectFilter = clsCompParaMes.SelectFilters.Grid
            .WhereFilter = clsCompParaMes.WhereFilters.Grid
            .OrderByFilter = clsCompParaMes.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("CompParaMesId")) > 0) Then
            With oCompParaMes
               .CompParaMesId = ToLong(grdMain.GetValue("CompParaMesId"))

               If .FindByPK Then
                  Dim frm As New frmCompParaMesEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oCompParaMes
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oCompParaMes
                  .WhereFilter = clsCompParaMes.WhereFilters.PrimaryKey
                  .CompParaMesId = ToLong(grdMain.GetValue("CompParaMesId"))
   ...
   Private Sub PrintReport()
      'Dim rpt As New rptCompParaMes

      'rpt.DataSource = GetDataView(moCompParaMes.DataSet.Tables(moCompParaMes.TableName))
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("CompParaMesId")
   ...
   Private Sub FormInit()
      ...
      moCompParaMes = New clsCompParaMes(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Correlativos de Periodos"
         .ContextMenu = mnuMain

         .RootTable.Columns("CompParaMesId").Visible = False
         ...
         .RootTable.Columns("MesId").Visible = False

         .RootTable.Columns("MesDes").Caption = "Mes"
         .RootTable.Columns("MesDes").Width = 120
         .RootTable.Columns("MesDes").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("MesDes").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
   ...
   Private Sub frmCompParaMes_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCompParaMes_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
