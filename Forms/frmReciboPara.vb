...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmReciboPara))
      ...
      Me.UiCommandBar1.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New1, Me.Separator1, Me.Edit1, Me.Separator2, Me.Refrescar1, Me.ViewAll1, Me.Separator4, Me.Print1, Me.Separator5, Me.Exit1})
      Me.UiCommandBar1.Key = "tbrMain"
      Me.UiCommandBar1.Location = New System.Drawing.Point(0, 0)
      Me.UiCommandBar1.Name = "UiCommandBar1"
      Me.UiCommandBar1.RowIndex = 0
      Me.UiCommandBar1.Size = New System.Drawing.Size(471, 28)
      ...
      Me.KeyPreview = True
      Me.Name = "frmReciboPara"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Parámetros de Recibo"
...
#End Region
   ...
   Private Sub frmReciboPara_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmReciboPara_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moReciboPara
            .SelectFilter = clsReciboPara.SelectFilters.Grid
            .WhereFilter = clsReciboPara.WhereFilters.Grid
            .OrderByFilter = clsReciboPara.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("ReciboParaId")) > 0) Then
            With oReciboPara
               .ReciboParaId = ToLong(grdMain.GetValue("ReciboParaId"))

               If .FindByPK Then
                  Dim frm As New frmReciboParaEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oReciboPara
   ...
   Private Sub FormNew()
      Try
         If Not ReciboParaExits(clsAppInfo.EmpresaId, clsAppInfo.GestionId) Then
            If MessageBox.Show("¿Realmente Quiere Aperturar los Parámetros?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               If ReciboParaAdd(clsAppInfo.GestionId) Then
                  Call modAuditoria.AudiOpeAdd(Me.Name, Me.Text, clsTipoOpera.NUEVO, "Apertura de Parámetros de Recibo" & "; Gestión " & clsAppInfo.Gestion)
                  Call grdMainLoad()
               End If
            End If
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oReciboPara
                  .WhereFilter = clsReciboPara.WhereFilters.PrimaryKey
                  .ReciboParaId = ToLong(grdMain.GetValue("ReciboParaId"))
   ...
   Private Function ReciboParaAdd(ByVal lngGestionId As Long) As Boolean
      Dim oReciboPara As New clsReciboPara(clsAppInfo.ConnectString)
      Dim oReciboParaAnt As New clsReciboPara(clsAppInfo.ConnectString)
      Dim lngGestionIdAnt As Long = GestionIdAnteriorExits()

      Try
         ReciboParaAdd = False

         If TableExits(clsAppInfo.ConnectString, oReciboPara.TableName) Then
            With oReciboPara
               .EmpresaId = mlngEmpresaId
               .GestionId = lngGestionId

               oReciboParaAnt.SelectFilter = clsReciboPara.SelectFilters.All
               oReciboParaAnt.WhereFilter = clsReciboPara.WhereFilters.TipoCompId
               oReciboParaAnt.EmpresaId = mlngEmpresaId
               oReciboParaAnt.GestionId = lngGestionIdAnt
               oReciboParaAnt.TipoCompId = 1

               If oReciboParaAnt.Find Then
                  .TipoCompId = oReciboParaAnt.TipoCompId
                  .NroIni = oReciboParaAnt.NroIni
                  .NroActual = oReciboParaAnt.NroIni - 1
                  .Firma = oReciboParaAnt.Firma
                  .TipoHojaId = oReciboParaAnt.TipoHojaId
   ...
   Private Function ReciboParaExits(ByVal lngEmpresaId As Long, ByVal lngGestionId As Long) As Boolean
      Dim oReciboPara As New clsReciboPara(clsAppInfo.ConnectString)

      ReciboParaExits = False
   ...
   Private Sub PrintReport()
      Dim rpt As New rptReciboPara

      rpt.DataSource = GetDataView(moReciboPara.DataSet.Tables(moReciboPara.TableName))

      rpt.lblTitle.Text = "Parámetros de Recibo"
      rpt.Document.Name = "Parámetros de Recibo"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("ReciboParaId")
   ...
   Private Sub FormInit()
      ...
      moReciboPara = New clsReciboPara(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Parámetros de Recibo"
         .ContextMenu = mnuMain

         .RootTable.Columns("ReciboParaId").Visible = False
         ...
         .RootTable.Columns("TipoCompDes").Caption = "Tipo Recibo"
         ...
         .RootTable.Columns("Firma").Width = 300
   ...
   Private Sub frmReciboPara_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmReciboPara_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
