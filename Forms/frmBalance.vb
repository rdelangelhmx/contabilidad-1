Public Class frmBalance
   ...
   Private mdatFechaIni As String
   Private mdatFechaFin As String
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.ToolBar1.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.Book1, Me.Separator1, Me.ViewAll1, Me.Separator2, Me.Print1, Me.Separator3, Me.Exit1})
...
#End Region
   ...
   Private Sub frmBalance_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
   ...
   Private Sub PrintReport()
      ...
      rpt.lblTitle.Text = If(String.IsNullOrEmpty(mstrTitulo), "Balance General", mstrTitulo)
      rpt.Document.Name = If(String.IsNullOrEmpty(mstrTitulo), "Balance General", mstrTitulo)
   ...
   Private Sub frmBalance_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moPlan.Dispose()
      Call ClearMemory()
   End Sub
...
#Region " DataSet-Balance "
   ...
   Private Function AddRowDataTable(ByVal oDataRow As DataRow, ByVal strTab As String) As Long
      ...
      If ToLong(oDataRow("TipoGrupoId")) = 1 Or ToLong(oDataRow("TipoGrupoId")) = 2 Or ToLong(oDataRow("TipoGrupoId")) = 3 Then
         ...
         If ToBoolean(oDataRow("TieneAnaAdd")) And mboolIncluirPlanAdd Then
            Call PlanAddLoad(oDataRow("PlanId"), strTab & "     ", ToLong(oDataRow("Nivel")), ToLong(oDataRow("TipoGrupoId")))
         End If
      End If
   End Function
   ...
   Private Sub UpdateRowDataTable(ByVal lngIndex As Long)
      ...
      If ToBoolean(oRow("EsAna")) Then
         ...
         End If
      Else
         oRow("GralBs") = ToDecimal(moDataTable.Compute("Sum(GralBsDet)", "PlanPadreId = " & ToLong(oRow("PlanId")))) _
         + ToDecimal(moDataTable.Compute("Sum(GralBs)", "PlanPadreId = " & ToLong(oRow("PlanId"))))
         oRow("GralUs") = ToDecimal(moDataTable.Compute("Sum(GralUsDet)", "PlanPadreId = " & ToLong(oRow("PlanId")))) _
         + ToDecimal(moDataTable.Compute("Sum(GralUs)", "PlanPadreId = " & ToLong(oRow("PlanId"))))
...
#Region " Metodo-Balance "
   ...
   Private Sub GetResultado()
      ...
      oRow("GralBsDet") = mdecResultadoBs
      oRow("GralUsDet") = mdecResultadoUs
   ...
   Private Sub addBalance()
      ...
      For Each row In moDataTable.Rows
         ...
         End If
      Next
      oRow("GralBsDet") = mdecResultadoBs + ToDecimal(oRow("GralBsDet"))
      oRow("GralUsDet") = mdecResultadoUs + ToDecimal(oRow("GralUsDet"))
      moDataTable.Rows.Add(oRow)
   End Sub
   ...
   Private Sub GetOrdenDeudora()
      ...
      oRow("GralBsDet") = OrdenDeudoraBs(decOrdenDeudorUs)
      oRow("GralUsDet") = decOrdenDeudorUs
   ...
   Private Sub GetOrdenAcreedora()
      ...
      oRow("GralBsDet") = OrdenAcreedoraBs(decOrdenAcreedoraUs)
      oRow("GralUsDet") = decOrdenAcreedoraUs
...
#Region " Grid-Balance "
   ...
   Private Sub grdMainInit()
      ...
      With grdMain
         ...
         Call MonedaDesFind(1, strMonedaSigla)

         .RootTable.Columns("GralBs").Caption = "General " & strMonedaSigla
         ...
         .RootTable.Columns("GralBsDet").Caption = "Detalle " & strMonedaSigla
         ...
         Call MonedaDesFind(2, strMonedaSigla)

         .RootTable.Columns("GralUs").Caption = "General " & strMonedaSigla
         ...
         .RootTable.Columns("GralUsDet").Caption = "Detalle " & strMonedaSigla
   ...
   Private Sub frmBalance_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
