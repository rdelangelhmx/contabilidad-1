...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      ExplorerBarGroup4.ContainerHeight = 371
...
#End Region
   ...
   Private Sub frmCentroCosto_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
   ...
   Private Sub grdMainLoad()
      Try
         With moCentroCosto
            .SelectFilter = clsCentroCosto.SelectFilters.Grid
            .WhereFilter = clsCentroCosto.WhereFilters.Grid
            .OrderByFilter = clsCentroCosto.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("CentroCostoId")) > 0) Then
            With oCentroCosto
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oCentroCosto.EmpresaId = mlngEmpresaId
   ...
   Private Sub CloneVM(ByRef oVM As clsCentroCostoVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            ...
            .CentroCostoCod = ToStr(grdMain.GetValue("CentroCostoCod"))
            .EstadoId = ToLong(grdMain.GetValue("EstadoId"))
            .EstadoDes = ToStr(grdMain.GetValue("EstadoDes"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               If Not TieneMovimiento(ToLong(grdMain.GetValue("CentroCostoId"))) Then
                  With oCentroCosto
                     .WhereFilter = clsCentroCosto.WhereFilters.PrimaryKey
                     .CentroCostoId = ToLong(grdMain.GetValue("CentroCostoId"))
                     If .IsDeleted Then
                  ...
                  End With
               Else
                  MessageBox.Show("Imposible Eliminar el Centro de Costo Debido a que ya Tiene Movimiento", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
               End If
            End If
         Else
            MessageBox.Show("Debe Seleccionar un Registro", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
   ...
   Private Function TieneMovimiento(ByVal lngCentroCostoId As Long) As Boolean
      ...
      Try
         ...
         With oCompDet
            ...
            .WhereFilter = clsCompDet.WhereFilters.CentroCostoId
            .EmpresaId = mlngEmpresaId
   ...
   Private Sub frmCentroCosto_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCentroCosto_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
