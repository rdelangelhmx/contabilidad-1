Public Class frmCentroCostoDetFind
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCentroCostoDetFind))
...
#End Region
   ...
   Private Sub frmCentroCostoDetFind_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCentroCostoDetFind_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub frmCentroCostoDetFind_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
      If Me.WindowState <> FormWindowState.Minimized Then
   ...
   Private Sub frmCentroCostoDetFind_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moCentroCostoDet.Dispose()
      Call ClearMemory()
   End Sub

#Region " CentroCostoDet "
#Region " Metodo-CentroCostoDet "
...
#Region " Grid-CentroCostoDet "
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Actividades"
         ...
         .RootTable.Columns("CentroCostoDetDes").Width = 250
   ...
   Private Sub SeleccionarActividad()
      If grdMain.RowCount > 0 And ToLong(grdMain.GetValue("CentroCostoDetId")) > 0 Then
         mlngID = ToLong(grdMain.GetValue("CentroCostoDetId"))
         mboolChanged = True
         Me.Close()
      Else
         MessageBox.Show("Debe Seleccionar una Actividad", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
      End If
   End Sub
