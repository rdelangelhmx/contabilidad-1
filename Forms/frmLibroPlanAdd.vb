...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmLibroPlanAdd))
      ...
      Me.KeyPreview = True
      Me.Name = "frmLibroPlanAdd"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Movimiento de Analíticos Adicionales"
...
#End Region
   ...
   Private Sub frmLibroPlanAdd_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmLibroPlanAdd_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub PrintReport()
      Try
         If (mlngMonedaId = 1) Or (mlngMonedaId = 2) Then
            ...
            rpt.lblTitle.Text = "Movimiento de Analíticos Adicionales"
            rpt.Document.Name = "Movimiento de Analíticos Adicionales"
...
#End Region
   ...
   Private Sub frmLibroPlanAdd_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmLibroPlanAdd_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
...
#Region " Grid-LibroPlanAdd "
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Movimiento de Analíticos Adicionales"
      ...
      Try
         ...
         For Each lngPlanId As Long In moLista
            If ConMovimiento(lngPlanId) Then
               ...
               moDataTable.Rows.Add(GetHeader(lngPlanId))
               ...
               moDataTable.Rows.Add(GetFooter(lngPlanId))
               moDataTable.Rows.Add(GetRowNull)
            End If
         Next
