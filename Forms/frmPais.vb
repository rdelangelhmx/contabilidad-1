...
#End Region
   ...
   Private Sub grdMainLoad()
      Try
         With moPais
            .SelectFilter = clsPais.SelectFilters.Grid
            .WhereFilter = clsPais.WhereFilters.Grid
            .OrderByFilter = clsPais.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("PaisId")) > 0) Then
            With oPais
               .PaisId = ToLong(grdMain.GetValue("PaisId"))

               If .FindByPK Then
                  Dim frm As New frmPaisEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oPais
   ...
   Private Sub CloneVM(ByRef oVM As clsPaisVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            ...
            .PaisCod = ToStr(grdMain.GetValue("PaisCod"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oPais
                  .WhereFilter = clsPais.WhereFilters.PrimaryKey
                  .PaisId = ToLong(grdMain.GetValue("PaisId"))
                  If .IsDeleted Then
                     Call CloneVM(.VMNew)
                     If .Delete Then
   ...
   Private Sub PrintReport()
      ...
      'rpt.DataSource = moPais.DataSet.Tables(moPais.TableName).DefaultView
      'rpt.lblBancoDes.Text = "Pais"
      'rpt.txtBancoDes.DataField = "PaisDes"

      'rpt.lblTitle.Text = "Paises"
      'rpt.Document.Name = "Paises"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("PaisId")
   ...
   Private Sub FormInit()
      ...
      moPais = New clsPais(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Países"
         .ContextMenu = mnuMain

         .RootTable.Columns("PaisId").Visible = False

         .RootTable.Columns("PaisCod").Caption = "Codigo"
         .RootTable.Columns("PaisCod").Width = 100
         .RootTable.Columns("PaisCod").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("PaisCod").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
   ...
   Private Sub frmPais_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmPais_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moPais.Dispose()
      Call ClearMemory()
   End Sub
End Class
