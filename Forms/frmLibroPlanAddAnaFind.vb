...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.Text = "Criterios Movimiento de Analíticos Adicionales Por Analíticos"
...
#Region " Grid-LibroPlanAna "
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         .RootTable.Columns("PlanAddCta").Caption = "Código"
         ...
         .RootTable.Columns("PlanAddDes").Caption = "Descripción"
...
#End Region
   ...
   Public Overrides Function ToString() As String
      Return "Gestión: " & clsAppInfo.Gestion & If(chkFecha.Checked, " Desde " & dtpFechaIni.Text & " Hasta " & dtpFechaFin.Text, "") & "; Cuenta: " & cboPlan.Text & "; C.C.: " & cboCentroCosto.Text & "; Moneda: " & cboMoneda.Text & "; Tipo Asiento: " & cboTipoAsiento.Text & "; Detalle de A.A.: " & If(chkIncluirDetalle.Checked, "Sí", "No") & "; Saldo Anterior: " & If(chkSaldoAnterior.Checked, "Sí", "No") & "; Analiticos con Saldo Cero: " & If(chkSaldoCero.Checked, "Sí", "No") & "; " & If(optGeneral.Checked, optGeneral.Text, optCuenta.Text)
   End Function
