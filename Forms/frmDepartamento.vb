...
#End Region
   ...
   Private Sub frmDepartamento_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
   ...
   Private Sub grdMainLoad()
      Try
         With moDepartamento
            .SelectFilter = clsDepartamento.SelectFilters.Grid
            .WhereFilter = clsDepartamento.WhereFilters.Grid
            .OrderByFilter = clsDepartamento.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("DepartamentoId")) > 0) Then
            With oDepartamento
               .DepartamentoId = ToLong(grdMain.GetValue("DepartamentoId"))

               If .FindByPK Then
                  Dim frm As New frmDepartamentoEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oDepartamento
   ...
   Private Sub CloneVM(ByRef oVM As clsDepartamentoVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            ...
            .DepartamentoCod = ToStr(grdMain.GetValue("DepartamentoCod"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oDepartamento
                  .WhereFilter = clsDepartamento.WhereFilters.PrimaryKey
                  .DepartamentoId = ToLong(grdMain.GetValue("DepartamentoId"))
                  If .IsDeleted Then
                     Call CloneVM(.VMNew)
                     If .Delete Then
   ...
   Private Sub PrintReport()
      ...
      'rpt.DataSource = moDepartamento.DataSet.Tables(moDepartamento.TableName).DefaultView
      'rpt.lblBancoDes.Text = "Departamento"
      'rpt.txtBancoDes.DataField = "DepartamentoDes"

      'rpt.lblTitle.Text = "Departamentoes"
      'rpt.Document.Name = "Departamentoes"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("DepartamentoId")
   ...
   Private Sub FormInit()
      ...
      moDepartamento = New clsDepartamento(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Departamentos"
         .ContextMenu = mnuMain

         .RootTable.Columns("DepartamentoId").Visible = False

         .RootTable.Columns("DepartamentoCod").Caption = "Codigo"
         .RootTable.Columns("DepartamentoCod").Width = 100
         .RootTable.Columns("DepartamentoCod").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("DepartamentoCod").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
   ...
   Private Sub frmDepartamento_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmDepartamento_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
