Public Class frmLibroCentroCostoDetFind
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmLibroCentroCostoDetFind))
      ...
      Me.ExplorerBarContainerControl4.Size = New System.Drawing.Size(756, 299)
      ...
      Me.grdMain.Size = New System.Drawing.Size(756, 299)
      ...
      Me.bcgMain.Size = New System.Drawing.Size(780, 414)
      ...
      Me.UiGroupBox1.Location = New System.Drawing.Point(572, 376)
      Me.UiGroupBox1.Name = "UiGroupBox1"
      Me.UiGroupBox1.Size = New System.Drawing.Size(201, 36)
      ...
      Me.chkIncluirDetalle.Location = New System.Drawing.Point(4, 14)
      Me.chkIncluirDetalle.Name = "chkIncluirDetalle"
      Me.chkIncluirDetalle.Size = New System.Drawing.Size(192, 16)
      Me.chkIncluirDetalle.TabIndex = 16
      Me.chkIncluirDetalle.Text = "Incluir Detalle de Actividades"
      ...
      Me.grbFac.Location = New System.Drawing.Point(573, 344)
      ...
      Me.ebrMain.Size = New System.Drawing.Size(772, 332)
      ...
      Me.UiGroupBox4.Location = New System.Drawing.Point(196, 342)
      Me.UiGroupBox4.Name = "UiGroupBox4"
      Me.UiGroupBox4.Size = New System.Drawing.Size(236, 72)
      ...
      Me.cboTipoAsiento.Size = New System.Drawing.Size(144, 20)
      ...
      Me.cboMoneda.Size = New System.Drawing.Size(143, 20)
      ...
      Me.UiGroupBox3.Location = New System.Drawing.Point(437, 342)
      Me.UiGroupBox3.Name = "UiGroupBox3"
      Me.UiGroupBox3.Size = New System.Drawing.Size(131, 72)
      ...
      Me.optCuenta.Location = New System.Drawing.Point(7, 43)
      Me.optCuenta.Name = "optCuenta"
      Me.optCuenta.Size = New System.Drawing.Size(116, 16)
      Me.optCuenta.TabIndex = 11
      ...
      '
      '
      Me.dtpFechaFin.DropDownCalendar.FirstMonth = New Date(2008, 8, 1, 0, 0, 0, 0)
      ...
      '
      '
      Me.dtpFechaIni.DropDownCalendar.FirstMonth = New Date(2008, 8, 1, 0, 0, 0, 0)
      ...
      Me.TopRebar1.Size = New System.Drawing.Size(780, 28)
      '
      'Separator1
      '
      ...
      Me.KeyPreview = True
      Me.Name = "frmLibroCentroCostoDetFind"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Criterios Movimiento de Actividades de C.C. Por Centro de Costos"
...
#End Region
   ...
   Private Sub cdmMain_CommandClick(ByVal sender As System.Object, ByVal e As Janus.Windows.UI.CommandBars.CommandEventArgs) Handles cdmMain.CommandClick
      ...
      Select Case e.Command.Key
         Case "Book"
            Call frmLibroCentroCostoDetLoad()
   ...
   Private Sub frmLibroCentroCostoDetFind_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmLibroCentroCostoDetFind_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
...
#End Region
   ...
   Private Sub frmLibroCentroCostoDetLoad()
      If ListPosition(cboMoneda, cboMoneda.SelectedIndex) <> 0 Then
         ...
         If oLista.Count Then
            ...
            If oListaTipoAsiento.Count Then
               Dim frm As New frmLibroCentroCostoDet
   ...
   Private Sub frmLibroCentroCostoDetFind_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmLibroCentroCostoDetFind_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
...
#End Region
   ...
   Public Overrides Function ToString() As String
      Return "Gestión: " & clsAppInfo.Gestion & If(chkFecha.Checked, " Desde " & dtpFechaIni.Text & " Hasta " & dtpFechaFin.Text, "") & "; Moneda: " & cboMoneda.Text & "; Tipo Asiento: " & cboTipoAsiento.Text & "; Incluir Detalle de Actividades: " & If(chkIncluirDetalle.Checked, "Sí", "No") & "; " & If(optGeneral.Checked, optGeneral.Text, optCuenta.Text)
   End Function
End Class
