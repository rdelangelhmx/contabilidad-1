...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmLibroITFFind))
      ...
      Me.ExplorerBarContainerControl4.Size = New System.Drawing.Size(681, 295)
      ...
      Me.grdMain.Size = New System.Drawing.Size(681, 295)
      ...
      Me.bcgMain.Size = New System.Drawing.Size(705, 409)
      ...
      Me.UiGroupBox1.Location = New System.Drawing.Point(176, 336)
      Me.UiGroupBox1.Name = "UiGroupBox1"
      Me.UiGroupBox1.Size = New System.Drawing.Size(292, 72)
      ...
      Me.cboTipoAsiento.Size = New System.Drawing.Size(196, 20)
      ...
      Me.grbFac.Location = New System.Drawing.Point(612, 338)
      ...
      ExplorerBarGroup3.ContainerHeight = 296
      ...
      Me.ebrMain.Size = New System.Drawing.Size(697, 328)
      ...
      Me.UiGroupBox3.Location = New System.Drawing.Point(472, 336)
      ...
      Me.TopRebar1.Size = New System.Drawing.Size(705, 28)
      '
      'frmLibroITFFind
      '
      ...
      Me.KeyPreview = True
      Me.Name = "frmLibroITFFind"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Criterios Movimiento de ITF"
...
#End Region
   ...
   Private Sub frmLibroITFFind_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmLibroITFFind_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
...
#End Region
   ...
   Private Sub frmLibroITFFind_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmLibroITFFind_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moPlan.Dispose()
      Call ClearMemory()
   End Sub

#Region " LIBRO-ITF "
#Region " Metodo-LibroITF "
   ...
   Private Sub grdMainLoad()
      Try
         With moPlan
            ...
            .WhereFilter = clsPlan.WhereFilters.GridTipoPlanId_MonedaId
...
#End Region
   ...
   Public Overrides Function ToString() As String
      Return "Gestión: " & clsAppInfo.Gestion & If(chkFecha.Checked, " Desde " & dtpFechaIni.Text & " Hasta " & dtpFechaFin.Text, "") & "; Tipo Asiento: " & cboTipoAsiento.Text & "; " & If(optGeneral.Checked, optGeneral.Text, optCuenta.Text)
   End Function
End Class
