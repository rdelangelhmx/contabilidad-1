Public Class frmFlujoEfectivoDet
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmFlujoEfectivoDet))
      ...
      Me.KeyPreview = True
      Me.Name = "frmFlujoEfectivoDet"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Flujo de Efectivo Detallado"
...
#End Region
   ...
   Private Sub frmFlujoEfectivoDet_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmFlujoEfectivoDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub PrintReport()
      Dim rpt As New rptFlujoEfectivoDet

      rpt.DataSource = GetDataView(moDataTable.DataSet.Tables(moComp.TableName))

      rpt.lblTitle.Text = "Flujo Efectivo Detallado"
      rpt.Document.Name = "Flujo Efectivo Detallado"
   ...
   Private Sub frmFlujoEfectivoDet_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmFlujoEfectivoDet_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moComp.Dispose()
      Call ClearMemory()
   End Sub

#Region " FLUJO-EFECTIVO "
#Region " Metodo-FlujoEfectivo "
   Private Sub AddConditionalFormatting()
      Dim fc As Janus.Windows.GridEX.GridEXFormatCondition

      fc = New Janus.Windows.GridEX.GridEXFormatCondition(grdMain.RootTable.Columns("CompId"), Janus.Windows.GridEX.ConditionOperator.Equal, -1)
      fc.FormatStyle.ForeColor = Color.DarkGreen
      grdMain.RootTable.FormatConditions.Add(fc)

      fc = New Janus.Windows.GridEX.GridEXFormatCondition(grdMain.RootTable.Columns("CompId"), Janus.Windows.GridEX.ConditionOperator.Equal, -2)
      fc.FormatStyle.ForeColor = Color.DarkBlue
      grdMain.RootTable.FormatConditions.Add(fc)
   End Sub

   Private Function TieneCuentaDisponible(ByVal lngCompId As Long) As Boolean
      Dim oCompDet As New clsCompDet(clsAppInfo.ConnectString)

      TieneCuentaDisponible = False

      Try
         With oCompDet
            .SelectFilter = clsCompDet.SelectFilters.Grid
            .WhereFilter = clsCompDet.WhereFilters.FlujoEfectivoDet
            .OrderByFilter = clsCompDet.OrderByFilters.Grid
            .CompId = lngCompId
            .Automatico = 0

            If .Find Then
               TieneCuentaDisponible = True
            End If
         End With
...
#Region " DataSet-FlujoEfectivo "
   ...
   Private Function GetRow(ByVal oDataRow As DataRow, ByVal strTipoCompDes As String, ByVal lngCompNro As Long) As DataRow
      Dim oRow As DataRow
      ...
      oRow("TipoCompDes") = strTipoCompDes
...
#Region " Grid-FlujoEfectivo "
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Libro Diario"
   ...
   Private Sub grdMainLoad()
      ...
      Try
         ...
         With moComp
            .SelectFilter = clsComp.SelectFilters.LibroDiario
            .WhereFilter = clsComp.WhereFilters.LibroDiario
            .OrderByFilter = clsComp.OrderByFilters.LibroDiario
            ...
            If .Open() Then
               Do While intRow < .DataSet.Tables(.TableName).Rows.Count
                  If TieneCuentaDisponible(.DataSet.Tables(.TableName).Rows(intRow).Item("CompId")) Then
                     With oCompDet
                        .SelectFilter = clsCompDet.SelectFilters.Grid
                        ...
                        If .Open() Then
                           ...
                           Do While intRowDet < .DataSet.Tables(.TableName).Rows.Count
                              moDataTable.Rows.Add(GetRow(.DataSet.Tables(.TableName).Rows(intRowDet), _
                                                          moComp.DataSet.Tables(moComp.TableName).Rows(intRow).Item("TipoCompDes"), _
                                                          moComp.DataSet.Tables(moComp.TableName).Rows(intRow).Item("CompNro")))
                              intRowDet += 1
                           Loop
                        End If
                     End With
