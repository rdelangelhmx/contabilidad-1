...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmLibroIVAFind))
      ...
      Me.bcgMain.Size = New System.Drawing.Size(424, 190)
...
#End Region
   ...
   Public Overrides Function ToString() As String
      Return Me.Text & ": Gestión: " & clsAppInfo.Gestion & "; Libro de " & cboLibro.Text & "; Tipo Asiento: " & cboTipoAsiento.Text & "; Sucursal: " & cboSucursal.Text & "; Del Periodo: " & cboMesIni.Text & " Al Periodo " & cboMesFin.Text & "; Ordenar por Fecha: " & If(optOrdenarFecha.Checked, "Sí", "No")
   End Function
