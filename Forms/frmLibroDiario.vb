...
#End Region
   ...
   Private Sub frmLibroDiario_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
   ...
   Private Sub PrintReport()
      ...
      rpt.lblTitle.Text = "Libro Diario"
      rpt.Document.Name = "Libro Diario"
   ...
   Private Sub frmLibroDiario_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmLibroDiario_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moComp.Dispose()
      Call ClearMemory()
   End Sub
