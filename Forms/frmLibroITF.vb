...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmLibroITF))
...
#End Region
   ...
   Private Sub frmLibroITF_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmLibroITF_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub PrintReport()
      Dim rpt As New rptLibroITF

      rpt.DataSource = GetDataView(moDataTable.DataSet.Tables(moCompDet.TableName))

      rpt.lblTitle.Text = "Movimiento de ITF"
      rpt.Document.Name = "Movimiento de ITF"
   ...
   Private Sub frmLibroITF_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmLibroITF_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moCompDet.Dispose()
      Call ClearMemory()
   End Sub
...
#Region " Metodo-LibroITF "
   ...
   Private Function CompDetAutomaticoFind(ByVal lngCompId As Long, ByVal lngCompDetId As Long) As Boolean
      Dim oCompDet As New clsCompDet(clsAppInfo.ConnectString)

      CompDetAutomaticoFind = False

      Try
         With oCompDet
            .SelectFilter = clsCompDet.SelectFilters.ListBox
...
#Region " DataSet-LibroITF "
   Private Sub moDataSetInit()
      ...
      moDataTable.Columns.Add("ITF", Type.GetType("System.Decimal"))
   End Sub
   ...
   Private Function GetRow(ByVal oDataRow As DataRow, ByVal lngMonedaId As Long) As DataRow
      ...
      If ToDecimal(oRow("Debe")) <> 0 Then
         oRow("ITF") = ToDecimal(oRow("Debe")) * clsAppInfo.ITF

      ElseIf ToDecimal(oRow("Haber")) <> 0 Then
         oRow("ITF") = ToDecimal(oRow("Haber")) * clsAppInfo.ITF
      End If

      mdecDebe = mdecDebe + ToDecimal(oRow("Debe"))
      mdecHaber = mdecHaber + ToDecimal(oRow("Haber"))
      mdecITF = mdecITF + ToDecimal(oRow("ITF"))
...
#Region " Grid-LibroITF "
   Private Sub grdMainInit()
      With grdMain
         ...
         .RootTable.Columns("ITF").Caption = "ITF"
         .RootTable.Columns("ITF").FormatString = DecimalMask()
         .RootTable.Columns("ITF").Width = 80
         .RootTable.Columns("ITF").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
         .RootTable.Columns("ITF").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
      End With
               ...
               If ConMovimiento(lngPlanId) Then
                  ...
                  If .Open() Then
                     ...
                     Do While intRow < .DataSet.Tables(.TableName).Rows.Count
                        If Not CBool(.DataSet.Tables(.TableName).Rows(intRow).Item("Automatico")) Then
                           If CompDetAutomaticoFind(ToLong(.DataSet.Tables(.TableName).Rows(intRow).Item("CompId")), ToLong(.DataSet.Tables(.TableName).Rows(intRow).Item("CompDetId"))) Then
