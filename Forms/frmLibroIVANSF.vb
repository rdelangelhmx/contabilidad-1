...
#End Region
   ...
   Private Sub PrintReportIN()
      ...
      If mlngTipoFacturaId = 1 Then 'Venta
         ...
         rpt.lblIVA.Text = "DÉBITO FISCAL I.V.A."
         rpt.lblNroRUC.Text = "Nº DE NIT / CI DEL CLIENTE"
         rpt.lblRegRUCDes.Text = "NOMBRE O RAZÓN SOCIAL DEL CLIENTE"
      ...
      ElseIf mlngTipoFacturaId = 2 Then 'Compra
         ...
         rpt.lblIVA.Text = "CRÉDITO FISCAL I.V.A."
         rpt.lblNroRUC.Text = "Nº DE NIT DEL PROVEEDOR"
         rpt.lblRegRUCDes.Text = "NOMBRE O RAZÓN SOCIAL DEL PROVEEDOR"
      End If
...
#Region " Grid-LibroIVANSF "
   Private Sub grdMainInit()
      With grdMain
         ...
         ElseIf mlngTipoFacturaId = 2 Then
            .RootTable.Columns("IVA").Caption = "Crédito"
         End If
