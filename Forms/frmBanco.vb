...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.tbrMain.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New1, Me.Separator1, Me.Edit1, Me.Separator2, Me.Delete1, Me.Separator6, Me.Refrescar1, Me.Separator3, Me.ViewAll1, Me.Separator4, Me.Print1, Me.Separator5, Me.Exit1})
...
#End Region
   ...
   Private Sub frmBanco_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
   ...
   Private Sub grdMainLoad()
      Try
         With moBanco
            .SelectFilter = clsBanco.SelectFilters.Grid
            .WhereFilter = clsBanco.WhereFilters.Grid
            .OrderByFilter = clsBanco.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("BancoId")) > 0) Then
            With oBanco
               .BancoId = ToLong(grdMain.GetValue("BancoId"))

               If .FindByPK Then
                  Dim frm As New frmBancoEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oBanco
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oBanco.EmpresaId = mlngEmpresaId
   ...
   Private Sub CloneVM(ByRef oVM As clsBancoVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            ...
            .BancoCod = ToStr(grdMain.GetValue("BancoCod"))
   ...
   Private Sub PrintReport()
      ''Dim rpt As New rptBanco

      ''rpt.DataSource = GetDataView(moBanco.DataSet.Tables(moBanco.TableName))

      ''rpt.lblTitle.Text = "Bancos"
      ''rpt.Document.Name = "Bancos"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("BancoId")
   ...
   Private Sub FormInit()
      ...
      moBanco = New clsBanco(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Bancos"
         .ContextMenu = mnuMain
         ...
         .RootTable.Columns("BancoCod").Caption = "Código"
         .RootTable.Columns("BancoCod").Width = 100
         .RootTable.Columns("BancoCod").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("BancoCod").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         ...
         .RootTable.Columns("PlanDes").Caption = "Cuenta Contable"
   ...
   Private Sub frmBanco_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmBanco_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moBanco.Dispose()
      Call ClearMemory()
   End Sub
End Class
