Public Class frmCentroCostoDet
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCentroCostoDet))
      ...
      Me.KeyPreview = True
      Me.Name = "frmCentroCostoDet"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Actividades de Centros de Costo"
...
#End Region
   ...
   Private Sub frmCentroCostoDet_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCentroCostoDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moCentroCostoDet
            .SelectFilter = clsCentroCostoDet.SelectFilters.Grid
            .WhereFilter = clsCentroCostoDet.WhereFilters.Grid
            .OrderByFilter = clsCentroCostoDet.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("CentroCostoDetId")) > 0) Then
            With oCentroCostoDet
               ...
               If .FindByPK Then
                  ...
                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oCentroCostoDet
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oCentroCostoDet.EmpresaId = mlngEmpresaId
   ...
   Private Sub CloneVM(ByRef oVM As clsCentroCostoDetVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            ...
            .CentroCostoDetCod = ToStr(grdMain.GetValue("CentroCostoDetCod"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               If Not TieneCompCentroCostoDet(ToLong(grdMain.GetValue("CentroCostoDetId"))) Then
                  With oCentroCostoDet
                  ...
                  End With
               Else
                  MessageBox.Show("Imposible Eliminar el Analítico Adicional Debido a que ya Tiene Movimiento", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
               End If
            End If
         Else
            MessageBox.Show("Debe Seleccionar un Registro", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
   ...
   Private Function TieneCompCentroCostoDet(ByVal lngCentroCostoDetId As Long) As Boolean
      Dim oCompCentroCostoDet As New clsCompCentroCostoDet(clsAppInfo.ConnectString)

      Try
         TieneCompCentroCostoDet = True

         With oCompCentroCostoDet
            .RowCountFilter = clsCompCentroCostoDet.RowCountFilters.All
            .WhereFilter = clsCompCentroCostoDet.WhereFilters.CentroCostoDetId
            .EmpresaId = mlngEmpresaId
            .CentroCostoDetId = lngCentroCostoDetId

            If ToLong(.RowCount) = 0 Then
               TieneCompCentroCostoDet = False
            End If
         End With
   ...
   Private Sub PrintReport()
      Dim rpt As New rptCentroCostoDet

      rpt.DataSource = GetDataView(moCentroCostoDet.DataSet.Tables(moCentroCostoDet.TableName))

      rpt.lblTitle.Text = "Actividades de Centros de Costo"
      rpt.Document.Name = "Actividades de Centros de Costo"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("CentroCostoDetId")
   ...
   Private Sub frmCentroCostoDet_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCentroCostoDet_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
