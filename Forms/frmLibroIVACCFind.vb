Public Class frmLibroIVACCFind
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmLibroIVACCFind))
      ...
      Me.bcgMain.Size = New System.Drawing.Size(424, 227)
      ...
      Me.UiGroupBox3.Location = New System.Drawing.Point(8, 180)
      Me.UiGroupBox3.Name = "UiGroupBox3"
      Me.UiGroupBox3.Size = New System.Drawing.Size(412, 40)
      Me.UiGroupBox3.TabIndex = 8
      ...
      Me.optOrdenarNumero.TabIndex = 10
      ...
      Me.UiGroupBox1.Size = New System.Drawing.Size(412, 140)
      ...
      Me.TopRebar1.Size = New System.Drawing.Size(424, 28)
      '
      'UiGroupBox2
      '
      ...
      Me.UiGroupBox2.Location = New System.Drawing.Point(8, 140)
      Me.UiGroupBox2.Name = "UiGroupBox2"
      Me.UiGroupBox2.Size = New System.Drawing.Size(412, 40)
...
#End Region
   ...
   Private Sub frmLibroIVACCFind_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmLibroIVACCFind_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
...
#End Region
            ...
            If cboSucursal.SelectedIndex <> -1 Then
               If cboMesIni.SelectedIndex <> -1 Then
                  If cboMesFin.SelectedIndex <> -1 Then
                     ...
                     End With
                  Else
                     MessageBox.Show("Debe Seleccionar el Período Final", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                  End If
               Else
                  MessageBox.Show("Debe Seleccionar el Período Inicial", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
               End If
            Else
   ...
   Private Sub frmLibroIVACCFind_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmLibroIVACCFind_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      Call ClearMemory()
   End Sub
...
#End Region
   ...
   Public Overrides Function ToString() As String
      Return Me.Text & ": Gestión: " & clsAppInfo.Gestion & "; Libro de " & cboLibro.Text & "; Tipo Asiento: " & cboTipoAsiento.Text & "; Sucursal: " & cboSucursal.Text & "; Del Periodo: " & cboMesIni.Text & " Al Periodo " & cboMesFin.Text & "; Centro Costo: " & cboCentroCosto.Text & "; Ordenar por Fecha: " & If(optOrdenarFecha.Checked, "Sí", "No")
   End Function
