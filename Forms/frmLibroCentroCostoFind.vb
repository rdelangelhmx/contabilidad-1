...
#End Region
   ...
   Public Overrides Function ToString() As String
      Return "Gestión: " & clsAppInfo.Gestion & If(chkFecha.Checked, " Desde " & dtpFechaIni.Text & " Hasta " & dtpFechaFin.Text, "") & "; Ordenar por Fecha: " & If(chkOrdenarFecha.Checked, "Sí", "No") & "; Moneda: " & cboMoneda.Text & "; Cuenta(s): " & cboPlan.Text & "; Tipo Asiento: " & cboTipoAsiento.Text & "; Incluir Saldo Anterior: " & If(chkSaldoAnterior.Checked, "Sí", "No") & "; Incluir Detalle de C.C.: " & If(chkIncluirDetalle.Checked, "Sí", "No") & "; " & If(optGeneral.Checked, optGeneral.Text, optCuenta.Text)
   End Function
End Class
