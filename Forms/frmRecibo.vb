...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   Friend WithEvents Comp As Janus.Windows.UI.CommandBars.UICommand
   Friend WithEvents Comp1 As Janus.Windows.UI.CommandBars.UICommand
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.Comp1 = New Janus.Windows.UI.CommandBars.UICommand("Comp")
      ...
      Me.Comp = New Janus.Windows.UI.CommandBars.UICommand("Comp")
      ...
      Me.cdmMain.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New2, Me.Edit, Me.Delete, Me.ViewAll, Me.Print, Me.Exit2, Me.Comp, Me.Refrescar})
      ...
      Me.UiCommandBar1.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New1, Me.Separator1, Me.Edit1, Me.Separator2, Me.Delete1, Me.Separator7, Me.Comp1, Me.Separator5, Me.Refrescar1, Me.Separator3, Me.ViewAll1, Me.Separator4, Me.Print1, Me.Separator6, Me.Exit1})
      Me.UiCommandBar1.Key = "tbrMain"
      Me.UiCommandBar1.Location = New System.Drawing.Point(0, 0)
      Me.UiCommandBar1.Name = "UiCommandBar1"
      Me.UiCommandBar1.RowIndex = 0
      Me.UiCommandBar1.Size = New System.Drawing.Size(645, 28)
      ...
      'Comp
      '
      Me.Comp.ImageIndex = 6
      Me.Comp.Key = "Comp"
      Me.Comp.Name = "Comp"
      Me.Comp.Text = "Comprobante"
      '
      'Refrescar
      '
...
#End Region
   ...
   Private Sub frmRecibo_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
   ...
   Private Sub grdMainLoad()
      Try
         With moRecibo
            .SelectFilter = clsRecibo.SelectFilters.Grid
            .WhereFilter = clsRecibo.WhereFilters.Grid
            .OrderByFilter = clsRecibo.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If grdMain.RowCount > 0 And ToLong(grdMain.GetValue("ReciboId")) > 0 Then
            With oRecibo
               .ReciboId = ToLong(grdMain.GetValue("ReciboId"))

               If .FindByPK Then
                  Dim frm As New frmReciboEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oRecibo
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oRecibo.EmpresaId = mlngEmpresaId
            oRecibo.GestionId = clsAppInfo.GestionId
            oRecibo.Fecha = ToDateDMY(Now.Date)
            oRecibo.EstadoId = 11
            ...
            If .Changed Then
               ...
               If MessageBox.Show("Recibo Guardado Exitosamente" + vbCrLf + "¿Desea Imprimir el Recibo?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
   ...
   Private Sub CloneVM(ByRef oVM As clsReciboVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            .ReciboId = ToLong(grdMain.GetValue("ReciboId"))
            .ReciboNro = ToLong(grdMain.GetValue("ReciboNro"))
   ...
   Private Sub DataDelete()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If ToLong(grdMain.GetValue("CompNro")) = 0 Then
               If MessageBox.Show("¿Realmente quiere eliminar el Recibo?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                  With oRecibo
                     .WhereFilter = clsRecibo.WhereFilters.PrimaryKey
                     .ReciboId = ToLong(grdMain.GetValue("ReciboId"))
               ...
               End If
            Else
               MessageBox.Show("Imposible Eliminar el Recibo", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If
         Else
            MessageBox.Show("Debe Seleccionar un Registro", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
         End If
   ...
   Private Sub CompFormNew()
      ...
      Try
         With frm
            ...
            oComp.Fecha = ToStr(grdMain.GetValue("Fecha"))
            oComp.MonedaId = ToLong(grdMain.GetValue("MonedaId"))
            oComp.TipoCambio = TipoCambioFind(ToDate(grdMain.GetValue("Fecha")))
            oComp.TipoCompId = ToLong(grdMain.GetValue("TipoCompId"))
            oComp.EntregadoA = ToStr(grdMain.GetValue("EntregadoA"))
            oComp.PorConcepto = ToStr(grdMain.GetValue("PorConcepto"))
            oComp.Glosa = ToStr(grdMain.GetValue("Glosa"))

            .DataObject = oComp
            .ShowDialog()

            If .Changed Then
               Dim lngReciboId As Long = ToLong(grdMain.GetValue("ReciboId"))

               If ReciboUpdate(lngReciboId, frm.ID, frm.CompNro) Then
                  Call grdMainLoad()
                  Call grdMainFindRow(lngReciboId)
   ...
   Private Sub CompDataEdit()
      Dim oComp As New clsComp(clsAppInfo.ConnectString)

      Try
         If grdMain.RowCount > 0 Then
            If (ToLong(grdMain.GetValue("EstadoId")) <> clsEstado.ANULADO) And (ToLong(grdMain.GetValue("EstadoId")) <> clsEstado.CERRADO) Then
               With oComp
                  .CompId = ToLong(grdMain.GetValue("CompId"))
   ...
   Private Function ReciboUpdate(ByVal lngReciboId As Long, ByVal lngCompId As Long, ByVal lngCompNro As Long) As Boolean
      Dim oRecibo As New clsRecibo(clsAppInfo.ConnectString)
      ...
      Try
         With oRecibo
            .ReciboId = lngReciboId

            If .FindByPK Then
               .UpdateFilter = clsRecibo.UpdateFilters.CompId
               .Fecha = ToDate(.Fecha)
               .CompId = lngCompId
               '.CompNro = lngCompNro
               ...
               .VMNew.ReciboId = lngReciboId
               .VMNew.CompId = lngCompId
               .VMNew.CompNro = lngCompNro
   ...
   Private Sub PrintReport()
      ...
      rpt.DataSource = GetDataView(moRecibo.DataSet.Tables(moRecibo.TableName))

      rpt.lblTitle.Text = "Listado de Recibos"
      rpt.Document.Name = "Listado de Recibos"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("ReciboId")
   ...
   Private Sub FormInit()
      ...
      moRecibo = New clsRecibo(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Registro de Recibos"
         .ContextMenu = mnuMain

         .RootTable.Columns("ReciboId").Visible = False
         ...
         .RootTable.Columns("ReciboNro").Caption = "Número"
         .RootTable.Columns("ReciboNro").Width = 80
         .RootTable.Columns("ReciboNro").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         .RootTable.Columns("ReciboNro").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         ...
         .RootTable.Columns("Glosa").Width = 100
         ...
         .RootTable.Columns("RespaldoId").Visible = False

         .RootTable.Columns("RespaldoDes").Caption = "Respaldo"
         .RootTable.Columns("RespaldoDes").Width = 100
         .RootTable.Columns("RespaldoDes").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("RespaldoDes").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("RespaldoNro").Caption = "Resp Nro"
         .RootTable.Columns("RespaldoNro").Width = 100
         .RootTable.Columns("RespaldoNro").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         .RootTable.Columns("RespaldoNro").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
   ...
   Private Sub AddConditionalFormatting()
      ...
      fc = New Janus.Windows.GridEX.GridEXFormatCondition(grdMain.RootTable.Columns("CompNro"), Janus.Windows.GridEX.ConditionOperator.NotEqual, 0)
   ...
   Private Sub frmRecibo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmRecibo_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moRecibo.Dispose()
      Call ClearMemory()
   End Sub
