...
#End Region
   ...
   Private Sub frmProvincia_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
   ...
   Private Sub grdMainLoad()
      Try
         With moProvincia
            .SelectFilter = clsProvincia.SelectFilters.Grid
            .WhereFilter = clsProvincia.WhereFilters.Grid
            .OrderByFilter = clsProvincia.OrderByFilters.Grid
      ...
      If grdMain.RowCount > 0 Then
         ...
         Try
            With oProvincia
               ...
               If .FindByPK Then
                  Dim frm As New frmProvinciaEdit
                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oProvincia
                  frm.ShowDialog()
                  frm.Dispose()
               End If
            End With
   ...
   Private Sub CloneVM(ByRef oVM As clsProvinciaVM)
      If clsAppInfo.RegistrarBitacora Then
         oVM = New clsProvinciaVM

         With oVM
            .ProvinciaId = ToLong(grdMain.GetValue("ProvinciaId"))
            .ProvinciaDes = ToStr(grdMain.GetValue("ProvinciaDes"))
            .ProvinciaCod = ToStr(grdMain.GetValue("ProvinciaCod"))
   ...
   Private Sub DataDelete()
      If grdMain.RowCount > 0 Then
         ...
         Dim lngProvinciaId As Long = ToLong(grdMain.GetValue("ProvinciaId"))
         If Not TieneMovivmiento(lngProvinciaId) Then
            ...
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               ...
               Try
                  With oProvincia
                     .WhereFilter = clsProvincia.WhereFilters.PrimaryKey
                     .ProvinciaId = lngProvinciaId
            ...
            End If
         Else
            MessageBox.Show("Imposible Eliminar Provincia Debido a que ya Tiene Movimiento", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
         End If
      Else
         MessageBox.Show("Debe Seleccionar un Registro", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
      End If
   ...
   Private Function TieneMovivmiento(ByVal lngProvinciaId As Long) As Boolean
      'Dim oEmpleado As New clsEmpleado(clsAppInfo.ConnectString) 'yova
      'TieneMovivmiento = False
      'Try

      '   With oEmpleado
      '      .RowCountFilter = clsEmpleado.RowCountFilters.All
      '      .WhereFilter = clsEmpleado.WhereFilters.Provincia
      '      .ProvinciaId = lngProvinciaId

      '      If ToLong(.FindOnly) Then
      '         TieneMovivmiento = True
      '      End If
      '   End With
   ...
   Private Sub PrintReport()
      Dim rpt As New rptProvincia

      Try
         rpt.DataSource = GetDataView(moProvincia.DataSet.Tables(moProvincia.TableName))
         rpt.lblTitle.Text = "Provincias"
         rpt.Document.Name = "Provincias"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("ProvinciaId")
   ...
   Private Sub FormInit()
      ...
      moProvincia = New clsProvincia(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Provincias"
         .ContextMenu = mnuMain
         ...
         .RootTable.Columns("ProvinciaCod").Caption = "Código"
         .RootTable.Columns("ProvinciaCod").Width = 100
         .RootTable.Columns("ProvinciaCod").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("ProvinciaCod").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("ProvinciaDes").Caption = "Provincia"
         .RootTable.Columns("ProvinciaDes").Width = 200
   ...
   Private Sub frmProvincia_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmProvincia_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moProvincia.Dispose()
      Call ClearMemory()
   End Sub
End Class
