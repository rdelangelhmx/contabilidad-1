Public Class frmEstadoResultadoFind
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmEstadoResultadoFind))
      ...
      Me.bcgMain.Size = New System.Drawing.Size(460, 280)
      ...
      Me.UiGroupBox1.Controls.Add(Me.chkPorMes)
      ...
      Me.UiGroupBox1.Size = New System.Drawing.Size(444, 216)
      ...
      Me.chkIncluirPlanAdd.Location = New System.Drawing.Point(8, 172)
      ...
      Me.cboTipoAsiento.Location = New System.Drawing.Point(116, 124)
      ...
      Me.UiGroupBox2.Location = New System.Drawing.Point(108, 44)
      ...
      Me.cboSucursal.Location = New System.Drawing.Point(132, 68)
      ...
      Me.grbFac.Location = New System.Drawing.Point(352, 143)
      ...
      Me.chkPorMes.Location = New System.Drawing.Point(298, 194)
      Me.chkPorMes.Name = "chkPorMes"
      Me.chkPorMes.Size = New System.Drawing.Size(140, 16)
      Me.chkPorMes.TabIndex = 17
      ...
      Me.dudNivel.Location = New System.Drawing.Point(116, 96)
      ...
      Me.cboCentroCosto.Location = New System.Drawing.Point(132, 44)
      ...
      Me.chkSaldoGestion.Location = New System.Drawing.Point(8, 194)
      ...
      Me.chkTotalizar.Location = New System.Drawing.Point(8, 152)
      ...
      Me.Name = "frmEstadoResultadoFind"
...
#End Region
   ...
   Private Sub frmEstadoResultadoFind_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmEstadoResultadoFind_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
...
#End Region
         ...
         If cboCentroCosto.SelectedIndex <> -1 Then
            ...
            If oListaTipoAsiento.Count Then
               If Not chkPorMes.Checked Then
                  Dim frm As New frmEstadoResultado
               ...
               Else
                  Dim frm As New frmEstadoResultadoMes
   ...
   Private Sub frmEstadoResultadoFind_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmEstadoResultadoFind_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      Call ClearMemory()
   End Sub
...
#End Region
   ...
   Public Overrides Function ToString() As String
      Return "Gestión: " & clsAppInfo.Gestion & If(chkFecha.Checked, "; Desde " & dtpFechaIni.Text & " Hasta " & dtpFechaFin.Text, "") & "; Moneda : " & cboMoneda.Text & "; C.C.: " & cboCentroCosto.Text & "; Suc: " & cboSucursal.Text & "; Nivel: " & dudNivel.Text & "; Tipo Asiento: " & cboTipoAsiento.Text & "; Totalizar: " & If(chkTotalizar.Checked, "Sí", "No") & "; Incluir A.A.: " & If(chkIncluirPlanAdd.Checked, "Sí", "No") & "; Incluir Saldos: " & If(chkSaldoGestion.Checked, "Sí", "No") & "; Comparativo por Mes: " & If(chkPorMes.Checked, "Sí", "No")
   End Function
