Public Class frmLibroCentroCostoEmpresas
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmLibroCentroCostoEmpresas))
      ...
      Me.KeyPreview = True
      Me.Name = "frmLibroCentroCostoEmpresas"
...
#End Region
   ...
   Private Sub frmLibroCentroCostoEmpresas_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmLibroCentroCostoEmpresas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
...
#End Region
   ...
   Private Sub frmLibroCentroCostoEmpresas_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmLibroCentroCostoEmpresas_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moCompDet.Dispose()
      Call ClearMemory()
   End Sub
...
#Region " Metodo-LibroCentroCosto "
   ...
   Private Function MonedaDesFind(ByVal lngMonedaId As Long) As String
      Dim oMoneda As New clsMoneda(mstrConnectString)
...
#Region " Grid-LibroCentroCosto"
   ...
   Private Sub grdMainLoad()
      ...
      Dim oCompDetPlan As New clsCompDet(mstrConnectString)
      Dim oRow As DataRow
