...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCompSucursal))
      ...
      Me.cdmMain.Id = New System.Guid("2e9ef608-f146-4a83-9848-e4c897c588da")
      ...
      Me.UiCommandBar1.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.ViewAll1, Me.Separator4, Me.Print1, Me.Separator5, Me.Exit1})
      ...
      Me.Name = "frmCompSucursal"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Sucursales del Comprobante"
...
#End Region
   ...
   Private Sub frmCompSucursal_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCompSucursal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moSucursal
            .SelectFilter = clsSucursal.SelectFilters.CompId
            .WhereFilter = clsSucursal.WhereFilters.CompId
            .OrderByFilter = clsSucursal.OrderByFilters.CompId
            .EmpresaId = mlngEmpresaId
            .SucursalId = mlngCompId
   ...
   Private Sub PrintReport()
      Dim rpt As New rptCompCentroCosto

      rpt.DataSource = GetDataView(moSucursal.DataSet.Tables(moSucursal.TableName))

      rpt.lblPlanCta.Text = "Cuenta"
      rpt.lblPlanDes.Text = "Descripción"
      rpt.lblCentroCostoCod.Text = "Código"
      rpt.lblCentroCostoDes.Text = "Sucursal"

      rpt.txtPlanCta.DataField = "PlanCTA"
      rpt.txtPlanDes.DataField = "PlanDes"
      rpt.txtCentroCostoCod.DataField = "SucursalCod"
      rpt.txtCentroCostoDes.DataField = "SucursalDes"
   ...
   Private Sub frmCompSucursal_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCompSucursal_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moSucursal.Dispose()
      Call ClearMemory()
   End Sub
End Class
