Public Class frmCompPlanEEFF
   ...
   'Private moTransaction As System.Data.OleDb.OleDbTransaction
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCompPlanEEFF))
      ...
      Me.Name = "frmCompPlanEEFF"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Cuenta de Flujo del Comprobante"
...
#End Region
   ...
   Private Sub frmCompPlanEEFF_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCompPlanEEFF_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moCompPlanEEFF
            .SelectFilter = clsCompPlanEEFF.SelectFilters.Grid
            .WhereFilter = clsCompPlanEEFF.WhereFilters.Grid
            .OrderByFilter = clsCompPlanEEFF.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("CompPlanEEFFId")) > 0) Then
            With oCompPlanEEFF
               .CompPlanEEFFId = ToLong(grdMain.GetValue("CompPlanEEFFId"))
   ...
   Private Sub CloneVM(ByRef oVM As clsCompPlanEEFFVM)
      If clsAppInfo.RegistrarBitacora And Not mboolNuevoComprobante Then
         ...
         With oVM
            ...
            .PlanEEFFId = ToLong(grdMain.GetValue("PlanEEFFId"))
            .PlanEEFFDes = ToStr(grdMain.GetValue("PlanEEFFDes"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oCompPlanEEFF
                  .WhereFilter = clsCompPlanEEFF.WhereFilters.PrimaryKey
                  .CompPlanEEFFId = ToLong(grdMain.GetValue("CompPlanEEFFId"))

                  Call CloneVM(.VMNew)
                  If .Delete() Then
                     If DataUpdateResto(moCompPlanEEFF.CompId) Then
                        bool = True
                        mboolChanged = True
                     End If
                  End If
   ...
   Private Sub PrintReport()
      Dim rpt As New rptCompPlanEEFF

      rpt.DataSource = GetDataView(moCompPlanEEFF.DataSet.Tables(moCompPlanEEFF.TableName))

      rpt.lblTitle.Text = "Flujos de Efectivo del Comprobante"
      rpt.Document.Name = "Flujos de Efectivo del Comprobante"
   ...
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Flujo de Efectivo"
         .ContextMenu = mnuMain
         ...
         .RootTable.Columns("PlanCta").Width = 90
         ...
         .RootTable.Columns("PlanEEFFCta").Caption = "Código Flujo"
         ...
         .RootTable.Columns("PlanEEFFDes").Width = 150
   ...
   Private Sub frmCompPlanEEFF_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCompPlanEEFF_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
