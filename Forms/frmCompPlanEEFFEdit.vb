Public Class frmCompPlanEEFFEdit
   ...
   WriteOnly Property DataObject() As clsCompPlanEEFF
      Set(ByVal Value As clsCompPlanEEFF)
         moCompPlanEEFF = Value
      End Set
   End Property
...
#Region " Windows Form Designer generated code "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCompPlanEEFFEdit))
      ...
      Me.cboPlanEEFF.Location = New System.Drawing.Point(116, 64)
...
#End Region
   ...
   Private Sub cdmMain_CommandClick(ByVal sender As System.Object, ByVal e As Janus.Windows.UI.CommandBars.CommandEventArgs) Handles cdmMain.CommandClick
      ...
      Select Case e.Command.Key
         Case "Save"
            If DataSave() Then
               mlngID = moCompPlanEEFF.CompPlanEEFFId
               mboolChanged = True
   ...
   Private Sub frmCompPlanEEFFEdit_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCompPlanEEFFEdit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
      ...
      If Not mboolAdding Then
         ...
         End If
      Else
         Me.Text = "Nuevo  Mov. Flujo de Efectivo"
         Call FormNew()
      End If
      ...
      With moCompPlanEEFF
         ...
         If clsAppInfo.RegistrarBitacora Then
            ...
            If Not mboolAdding And Not mboolEditing Then
               .VMOld.FormText = "Consulta Mov. Flujo de Efectivo"
   ...
   Private Sub CloneVM(ByRef oVM As clsCompPlanEEFFVM)
      oVM = New clsCompPlanEEFFVM

      If clsAppInfo.RegistrarBitacora And Not mboolNuevoComprobante Then
         With oVM
            .CompPlanEEFFId = moCompPlanEEFF.CompPlanEEFFId
            .CompId = moCompPlanEEFF.CompId
            .CompNro = CompNroFind(.CompId, .TipoCompId)
            .TipoCompDes = TipoCompDesFind(.TipoCompId)
            .PlanId = moCompPlanEEFF.PlanId
            .PlanEEFFId = moCompPlanEEFF.PlanEEFFId
            .PlanEEFFDes = cboPlanEEFF.Text
            .DebeOrg = moCompPlanEEFF.DebeOrg
            .HaberOrg = moCompPlanEEFF.HaberOrg
   ...
   Private Sub DataMove()
      With moCompPlanEEFF
         If Not mboolAdding Then
            .CompPlanEEFFId = ToLong(txtCompPlanEEFFId.Text)
         End If

         .PlanEEFFId = ListPosition(cboPlanEEFF)
   ...
   Private Function DataSave() As Boolean
      Try
         ...
         'Call CloseConectionTransaction(DataSave)
   ...
   'Public Sub OpenConectionTransaction()
   '   moConnection = New System.Data.OleDb.OleDbConnection(clsAppInfo.ConnectString)
   '   moConnection.Open()

   '   If moConnection.State = ConnectionState.Open Then
   '      moTransaction = moConnection.BeginTransaction(IsolationLevel.ReadUncommitted)
   '   End If
   'End Sub

   'Public Sub CloseConectionTransaction(ByRef bool As Boolean)
   '   Try
   '      If bool Then
   ...
   Private Function DataAdd() As Boolean
      Try
         ...
         If moCompPlanEEFF.Insert() Then
            If CompPlanEEFFResto(moCompPlanEEFF.CompId) Then
               mboolAdding = False
               DataAdd = True
            End If
         End If
   ...
   Private Function FormCheck() As Boolean
      ...
      If (CompPlanEEFFMonto() + ToDecimal(txtImporte.Text)) > mdecCompDetMonto Then
         FormCheck = False
   ...
   Private Function CompPlanEEFFMonto() As Decimal
      ...
      Try
         ...
         With oCompPlanEEFF
            ...
            .EmpresaId = moCompPlanEEFF.EmpresaId
            .CompId = moCompPlanEEFF.CompId
            .CompDetId = moCompPlanEEFF.CompDetId

            If .Open Then
               Do While .Read()
                  If mboolEditing Then
                     If ToLong(txtCompPlanEEFFId.Text) <> .CompPlanEEFFId Then
                        decDebe += .DebeOrg
                        decHaber += .HaberOrg
                     End If
         ...
         CompPlanEEFFMonto = Math.Abs(decDebe - decHaber)
         CompPlanEEFFMonto = ToDecimalMinor(CompPlanEEFFMonto)
   ...
   Private Function CompPlanEEFFResto(ByVal lngCompId As Long) As Boolean
      Dim oCompPlanEEFF As New clsCompPlanEEFF(clsAppInfo.ConnectString)

      Try
         CompPlanEEFFResto = False
         ...
         With oCompPlanEEFF
            ...
            If .Open Then
               Do While .Read()
                  If .CompPlanEEFFId <> moCompPlanEEFF.CompPlanEEFFId Then
                     If mlngCompMonedaId = 1 Then
                        .DebeBs = .DebeOrg
                        .HaberBs = .HaberOrg
            ...
            If mboolAdding Or mboolEditing Then
               ...
               Try
                  With frm
                     .NewRecord = True
                     .Editing = False
                     oPlanEEFF.EmpresaId = moCompPlanEEFF.EmpresaId
   ...
   Private Sub frmCompPlanEEFFEdit_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
      If Me.WindowState <> FormWindowState.Minimized Then
   ...
   Private Sub frmCompPlanEEFFEdit_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
