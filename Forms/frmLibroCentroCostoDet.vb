Public Class frmLibroCentroCostoDet
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmLibroCentroCostoDet))
      ...
      Me.KeyPreview = True
      Me.Name = "frmLibroCentroCostoDet"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Movimiento de Actividades de Centros de Costo"
...
#End Region
   ...
   Private Sub frmLibroCentroCostoDet_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmLibroCentroCostoDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
...
#End Region
   ...
   Private Sub frmLibroCentroCostoDet_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmLibroCentroCostoDet_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moCompCentroCostoDet.Dispose()
      Call ClearMemory()
   End Sub

#Region " LIBRO-CENTRO-COSTO "
#Region " Metodo-LIBRO-CENTRO-COSTO "
...
#Region " DataSet-LibroCentroCosto "
   ...
   Private Function GetRow(ByVal oDataRow As DataRow, ByVal lngMonedaId As Long) As DataRow
      ...
      mdecDebeBs += oRow("DebeBs")
      mdecHaberBs += oRow("HaberBs")
      mdecDebeUs += oRow("DebeUs")
      mdecHaberUs += oRow("HaberUs")
      ...
      Try
         ...
         For Each lngCentroCostoId As Long In moLista
            If ConMovimiento(lngCentroCostoId) Then
                        ...
                        With oCompCentroCostoDetPlanId 'Lista de Cuentas Contables
                           ...
                           If .Open() Then
                              For Each oRowPlanId In .DataSet.Tables(.TableName).Rows
                                 ...
                                 If SaldoCentroCostoDetBs(oRowPlanId("PlanId"), .CentroCostoId, .CentroCostoDetId, 0) <> 0 Then
               ...
               moDataTable.Rows.Add(GetFooter(lngCentroCostoId))
               moDataTable.Rows.Add(GetRowNull)
            End If
         Next
