...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCompPlanAdd))
      ...
      Me.Name = "frmCompPlanAdd"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Analíticos Adicionales del Comprobante"
...
#End Region
   ...
   Private Sub frmCompPlanAdd_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCompPlanAdd_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moCompPlanAdd
            .SelectFilter = clsCompPlanAdd.SelectFilters.Grid
            .WhereFilter = clsCompPlanAdd.WhereFilters.Grid
            .OrderByFilter = clsCompPlanAdd.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("CompPlanAddId")) > 0) Then
            With oCompPlanAdd
               .CompPlanAddId = ToLong(grdMain.GetValue("CompPlanAddId"))
   ...
   Private Sub CloneVM(ByRef oVM As clsCompPlanAddVM)
      If clsAppInfo.RegistrarBitacora And Not mboolNuevoComprobante Then
         ...
         With oVM
            ...
            .PlanAddId = ToLong(grdMain.GetValue("PlanAddId"))
            .PlanAddDes = ToStr(grdMain.GetValue("PlanAddDes"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oCompPlanAdd
                  .WhereFilter = clsCompPlanAdd.WhereFilters.PrimaryKey
                  .CompPlanAddId = ToLong(grdMain.GetValue("CompPlanAddId"))

                  Call CloneVM(.VMNew)
                  If .Delete Then
                     .CloseConection()
                     If DataUpdateResto(moCompPlanAdd.CompId) Then
                        Call grdMainLoad()
                        mboolChanged = True
                     End If
                  End If
   ...
   Private Sub PrintReport()
      Dim rpt As New rptCompPlanAdd

      rpt.DataSource = GetDataView(moCompPlanAdd.DataSet.Tables(moCompPlanAdd.TableName))

      rpt.lblTitle.Text = "Analíticos Adicionales del Comprobante"
      rpt.Document.Name = "Analíticos Adicionales del Comprobante"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("CompPlanAddId")
   ...
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Analíticos Adicionales"
         .ContextMenu = mnuMain

         .RootTable.Columns("CompPlanAddId").Visible = False
         ...
         .RootTable.Columns("PlanAddCta").Caption = "Código A.A."
         .RootTable.Columns("PlanAddCta").Width = 90
         ...
         .RootTable.Columns("PlanAddDes").Caption = "Descripción A.A."
         .RootTable.Columns("PlanAddDes").Width = 150
   ...
   Private Sub frmCompPlanAdd_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCompPlanAdd_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
