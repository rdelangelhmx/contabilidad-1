...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmRegRUC))
      ...
      Me.cdmMain.Id = New System.Guid("d71b5d73-099e-46cd-846d-89e2aaf62c89")
...
#End Region
   ...
   Private Sub frmRegRUC_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmRegRUC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moRegRUC
            .SelectFilter = clsRegRUC.SelectFilters.Grid
            .WhereFilter = clsRegRUC.WhereFilters.Grid
            .OrderByFilter = clsRegRUC.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("RegRUCId")) > 0) Then
            With oRegRUC
               .RegRUCId = ToLong(grdMain.GetValue("RegRUCId"))
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oRegRUC.EmpresaId = mlngEmpresaId
   ...
   Private Sub CloneVM(ByRef oVM As clsRegRucVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            .RegRucId = ToLong(grdMain.GetValue("RegRucId"))
            .NroRuc = ToStr(grdMain.GetValue("NroRuc"))
            .RegRucDes = ToStr(grdMain.GetValue("RegRucDes"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oRegRUC
                  .WhereFilter = clsRegRUC.WhereFilters.PrimaryKey
                  .RegRUCId = ToLong(grdMain.GetValue("RegRUCId"))
                  If .IsDeleted Then
   ...
   Private Sub PrintReport()
      Dim rpt As New rptRegRUC

      rpt.DataSource = GetDataView(moRegRUC.DataSet.Tables(moRegRUC.TableName))

      rpt.lblTitle.Text = "Catálogo de NIT"
      rpt.Document.Name = "Catálogo de NIT"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("RegRUCId")
   ...
   Private Sub FormInit()
      ...
      moRegRUC = New clsRegRUC(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Catálogo de NIT"
         .ContextMenu = mnuMain
         ...
         .RootTable.Columns("NroAutorizacion").Caption = "Nro Autorizacion"
   ...
   Private Sub frmRegRUC_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmRegRUC_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moRegRUC.Dispose()
      Call ClearMemory()
   End Sub
