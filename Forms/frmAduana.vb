...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmAduana))
...
#End Region
   ...
   Private Sub frmAduana_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmAduana_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moAduana
            .SelectFilter = clsAduana.SelectFilters.Grid
            .WhereFilter = clsAduana.WhereFilters.Grid
            .OrderByFilter = clsAduana.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("AduanaId")) > 0) Then
            With oAduana
               .AduanaId = ToLong(grdMain.GetValue("AduanaId"))

               If .FindByPK Then
                  Dim frm As New frmAduanaEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oAduana
   ...
   Private Sub CloneVM(ByRef oVM As clsAduanaVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            .AduanaId = ToLong(grdMain.GetValue("AduanaId"))
            .AduanaNIT = ToStr(grdMain.GetValue("AduanaNIT"))
            .AduanaDes = ToStr(grdMain.GetValue("AduanaDes"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oAduana
                  .WhereFilter = clsAduana.WhereFilters.PrimaryKey
                  .AduanaId = ToLong(grdMain.GetValue("AduanaId"))
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("AduanaId")
   ...
   Private Sub FormInit()
      ...
      moAduana = New clsAduana(clsAppInfo.ConnectString)
   End Sub

   Private Sub PrintReport()
      Dim rpt As New rptAduana

      rpt.DataSource = GetDataView(moAduana.DataSet.Tables(moAduana.TableName))

      rpt.lblTitle.Text = "Agencias Aduaneras"
      rpt.Document.Name = "Agencias Aduaneras"
   ...
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Agencias Aduaneras"
         .ContextMenu = mnuMain
         ...
         .RootTable.Columns("AduanaDes").Caption = "Razón Social"
         .RootTable.Columns("AduanaDes").Width = 200
   ...
   Private Sub frmAduana_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmAduana_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moAduana.Dispose()
      Call ClearMemory()
   End Sub
