...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   Friend WithEvents uiBackground As Janus.Windows.EditControls.UIGroupBox
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmRespaldo))
      ...
      Me.cdmMain.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New2, Me.Edit, Me.Delete, Me.ViewAll2, Me.Print, Me.Exit2, Me.Refrescar})
      ...
      Me.tbrMain.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New1, Me.Separator1, Me.Edit1, Me.Separator2, Me.Delete1, Me.Separator3, Me.Refrescar1, Me.Separator6, Me.ViewAll1, Me.Separator4, Me.Print1, Me.Separator5, Me.Exit1})
      Me.tbrMain.Key = "tbrMain"
      Me.tbrMain.Location = New System.Drawing.Point(0, 0)
      Me.tbrMain.Name = "tbrMain"
      Me.tbrMain.RowIndex = 0
      Me.tbrMain.Size = New System.Drawing.Size(542, 28)
      ...
      Me.Text = "Documentos de Respaldo"
...
#End Region
   ...
   Private Sub frmRespaldo_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
   ...
   Private Sub grdMainLoad()
      Try
         With moRespaldo
            .SelectFilter = clsRespaldo.SelectFilters.Grid
            .WhereFilter = clsRespaldo.WhereFilters.Grid
            .OrderByFilter = clsRespaldo.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("RespaldoId")) > 0) Then
            With oRespaldo
               .RespaldoId = ToLong(grdMain.GetValue("RespaldoId"))

               If .FindByPK Then
                  Dim frm As New frmRespaldoEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oRespaldo
   ...
   Private Sub CloneVM(ByRef oVM As clsRespaldoVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            .RespaldoId = ToLong(grdMain.GetValue("RespaldoId"))
            .RespaldoDes = ToStr(grdMain.GetValue("RespaldoDes"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oRespaldo
                  .WhereFilter = clsRespaldo.WhereFilters.PrimaryKey
                  .RespaldoId = ToLong(grdMain.GetValue("RespaldoId"))
                  If .IsDeleted Then
                     Call CloneVM(.VMNew)
                     If .Delete Then
   ...
   Private Sub PrintReport()
      'Dim rpt As New rptRespaldo

      'rpt.DataSource = GetDataView(moRespaldo.DataSet.Tables(moRespaldo.TableName))

      'rpt.lblTitle.Text = "Respaldos"
      'rpt.Document.Name = "Respaldos"
      ...
      'rpt.Document.Printer.PaperKind = Drawing.Printing.PaperKind.Letter
      'Call ForcePageSize(rpt.Document.Printer, System.Drawing.Printing.PaperKind.Letter)
      'rpt.PageSettings.PaperKind = Drawing.Printing.PaperKind.Letter
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("RespaldoId")
   ...
   Private Sub FormInit()
      ...
      moRespaldo = New clsRespaldo(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Documentos de Respaldo"
         .ContextMenu = mnuMain

         .RootTable.Columns("RespaldoId").Visible = False

         .RootTable.Columns("RespaldoDes").Caption = "Documento de Respaldo"
         .RootTable.Columns("RespaldoDes").Width = 200
   ...
   Private Sub frmRespaldo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmRespaldo_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moRespaldo.Dispose()
      Call ClearMemory()
   End Sub
