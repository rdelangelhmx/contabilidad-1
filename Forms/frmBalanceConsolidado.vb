Public Class frmBalanceConsolidado
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmBalanceConsolidado))
      ...
      Me.KeyPreview = True
      Me.Name = "frmBalanceConsolidado"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Balance General Consolidado"
...
#End Region
   ...
   Private Sub PrintReport()
      Dim rpt As New rptBalanceConsolidado
      Dim strMonedaSigla As String

      rpt.DataSource = GetDataView(moDataTable.DataSet.Tables(moPlan.TableName))

      rpt.lblTitle.Text = "Balance General Consolidado"
      rpt.Document.Name = "Balance General Consolidado"
   ...
   Private Sub frmBalanceConsolidado_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moPlan.Dispose()
      Call ClearMemory()
   End Sub
...
#Region " Grid-Balance "
   ...
   Private Sub grdMainLoad()
      ...
      For Me.mlngpos = 0 To moDataTableEmpresas.Rows.Count - 1
         ...
         For Each oRow In moDataTable.Rows
            ...
            If ToLong(oRow("Id")) = 1 Or ToLong(oRow("Id")) = 2 Or ToLong(oRow("Id")) = 3 Or ToLong(oRow("Id")) = 11 _
            Or ToLong(oRow("Id")) = 12 Or ToLong(oRow("Id")) = 13 Or ToLong(oRow("Id")) = 14 Then 'Sum cuentas agrupadoras
               oRow("GralBsDet") = ToDecimal(oRow("GralBsDet")) + ToDecimal(oRow("GralBsDetaux"))
               oRow("GralUsDet") = ToDecimal(oRow("GralUsDet")) + ToDecimal(oRow("GralUsDetaux"))
               '  oRow("GralBsGes") = ToDecimal(oRow("GralBsGes")) + ToDecimal(oRow("GralBsGesaux"))
               ' oRow("GralUsGes") = ToDecimal(oRow("GralUsGes")) + ToDecimal(oRow("GralUsGesaux"))
   ...
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Balance General Consolidado"
   ...
   Private Sub frmBalanceConsolidado_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
#End Region
   ...
   Private Sub GetResultado()
      ...
      oRow("GralBsDetaux") = mdecResultadoBs
      oRow("GralUsDetaux") = mdecResultadoUs
   End Sub
   ...
   Private Sub addBalance()
      ...
      '  moDataTable.Select("PlanPadreId = 0 and ")

      For Each row In moDataTable.Rows
         If ToLong(row("PlanPadreId")) = 0 And (ToStr(row("PlanCta")).Equals("2") _
         Or ToStr(row("PlanCta")).Equals("3")) Then
            oRow("GralBsDetaux") = ToDecimal(oRow("GralBsDetaux")) + ToDecimal(row("GralBsaux"))
            oRow("GralUsDetaux") = ToDecimal(oRow("GralUsDetaux")) + ToDecimal(row("GralUsaux"))
         End If
      Next
      oRow("GralBsDetaux") = mdecResultadoBs + ToDecimal(oRow("GralBsDetaux"))
      oRow("GralUsDetaux") = mdecResultadoUs + ToDecimal(oRow("GralUsDetaux"))
   ...
   Private Sub GetOrdenDeudora()
      ...
      End If
      oRow("GralBsDetaux") = OrdenDeudoraBs(decOrdenDeudorUs)
      oRow("GralUsDetaux") = decOrdenDeudorUs
   End Sub
   ...
   Private Sub GetOrdenAcreedora()
      ...
      End If
      oRow("GralBsDetaux") = OrdenAcreedoraBs(decOrdenAcreedoraUs)
      oRow("GralUsDetaux") = decOrdenAcreedoraUs
   End Sub
