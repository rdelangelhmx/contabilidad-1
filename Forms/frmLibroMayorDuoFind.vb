Public Class frmLibroMayorDuoFind
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmLibroMayorDuoFind))
      ...
      Me.ExplorerBarContainerControl4.Size = New System.Drawing.Size(848, 295)
      ...
      Me.grdMain.Size = New System.Drawing.Size(848, 295)
      ...
      Me.bcgMain.Size = New System.Drawing.Size(872, 414)
      ...
      Me.UiGroupBox1.Location = New System.Drawing.Point(552, 340)
      Me.UiGroupBox1.Name = "UiGroupBox1"
      Me.UiGroupBox1.Size = New System.Drawing.Size(211, 72)
      ...
      Me.chkSaldoAnterior.Location = New System.Drawing.Point(4, 19)
      Me.chkSaldoAnterior.Name = "chkSaldoAnterior"
      Me.chkSaldoAnterior.Size = New System.Drawing.Size(202, 20)
      ...
      Me.chkSinMovimiento.Location = New System.Drawing.Point(4, 42)
      Me.chkSinMovimiento.Name = "chkSinMovimiento"
      Me.chkSinMovimiento.Size = New System.Drawing.Size(202, 20)
      Me.chkSinMovimiento.TabIndex = 2
      ...
      ExplorerBarGroup1.ContainerHeight = 296
      ...
      Me.ebrMain.Size = New System.Drawing.Size(864, 328)
      ...
      Me.chkOrdenarFecha.Location = New System.Drawing.Point(136, 336)
      ...
      Me.UiGroupBox3.Location = New System.Drawing.Point(412, 340)
      Me.UiGroupBox3.Name = "UiGroupBox3"
      Me.UiGroupBox3.Size = New System.Drawing.Size(136, 72)
      ...
      Me.optCuenta.Location = New System.Drawing.Point(8, 44)
      ...
      Me.optGeneral.Location = New System.Drawing.Point(8, 20)
      ...
      Me.UiGroupBox2.Location = New System.Drawing.Point(192, 340)
      Me.UiGroupBox2.Name = "UiGroupBox2"
      Me.UiGroupBox2.Size = New System.Drawing.Size(216, 72)
      ...
      Me.cboTipoAsiento.Location = New System.Drawing.Point(88, 40)
      ...
      Me.cboMoneda.Location = New System.Drawing.Point(88, 15)
      ...
      Me.TopRebar1.Size = New System.Drawing.Size(872, 28)
      '
      'frmLibroMayorDuoFind
      '
...
#End Region
   ...
   Private Sub frmLibroMayorDuoFind_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmLibroMayorDuoFind_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
...
#End Region
         ...
         If oLista.Count Then
            ...
            If oListaTipoAsiento.Count Then
               If frmDataBaseOrgLoad() Then
                  Dim frm As New frmLibroMayorDuo
   ...
   Private Function frmDataBaseOrgLoad() As Boolean
      ...
      With frm
         ...
         '   .Server = clsAppInfo.ServerTemp
         '   .Usuario = clsAppInfo.UserTemp
         '   .Password = clsAppInfo.PassTemp
         '   .Database = clsAppInfo.DataBaseTemp
         '   .EmpresaId = clsAppInfo.EmpresaIdTemp
         '   .GestionId = clsAppInfo.GestionIdTemp
         '   .Recordar = clsAppInfo.Recordar
         'End If
         ...
         If .Changed Then
            'If .Recordar Then
            '   clsAppInfo.ServerTemp = .Server
            '   clsAppInfo.UserTemp = .Usuario
            '   clsAppInfo.PassTemp = .Password
            '   clsAppInfo.DataBaseTemp = .Database
            '   clsAppInfo.EmpresaIdTemp = .EmpresaId
            '   clsAppInfo.GestionIdTemp = .GestionId
            '   clsAppInfo.Recordar = .Recordar
            'Else
   ...
   Private Sub frmLibroMayorDuoFind_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmLibroMayorDuoFind_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moPlan.Dispose()
      Call ClearMemory()
   End Sub
...
#End Region
   ...
   Public Overrides Function ToString() As String
      ...
      Next
      Return "Gestión: " & clsAppInfo.Gestion & "; " & If(chkFecha.Checked, " Desde " & dtpFechaIni.Text & " Hasta " & dtpFechaFin.Text, "") & "; " & If(chkOrdenarFecha.Checked, "Ordenar Fecha", "") & "; Moneda: " & cboMoneda.Text & "; Tipo Asiento: " & cboTipoAsiento.Text & "; " & If(optGeneral.Checked, optGeneral.Checked, optCuenta.Checked) & "; Incluir Saldo Anterior: " & If(chkSaldoAnterior.Checked, "Sí", "No") & "; Mostrar Cuenta sin Mov.: " & If(chkSinMovimiento.Checked, "Sí", "No") & "; Cuentas: " & strPlan
   End Function
End Class
