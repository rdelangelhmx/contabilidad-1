Public Class frmLibroDispoComparativoFind
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmLibroDispoComparativoFind))
      ...
      Me.ExplorerBarContainerControl4.Size = New System.Drawing.Size(728, 235)
      ...
      Me.grdMain.Size = New System.Drawing.Size(728, 235)
      ...
      Me.grpEmpresa.Size = New System.Drawing.Size(744, 60)
      ...
      Me.cboEmpresa.Size = New System.Drawing.Size(664, 20)
      ...
      Me.UiGroupBox1.Location = New System.Drawing.Point(452, 336)
      Me.UiGroupBox1.Name = "UiGroupBox1"
      Me.UiGroupBox1.Size = New System.Drawing.Size(155, 72)
      ...
      Me.chkSaldoAnterior.Location = New System.Drawing.Point(6, 16)
      Me.chkSaldoAnterior.Name = "chkSaldoAnterior"
      Me.chkSaldoAnterior.Size = New System.Drawing.Size(144, 20)
      Me.chkSaldoAnterior.TabIndex = 10
      ...
      Me.grbFac.Location = New System.Drawing.Point(612, 336)
      Me.grbFac.Name = "grbFac"
      Me.grbFac.Size = New System.Drawing.Size(84, 32)
      Me.grbFac.TabIndex = 11
      ...
      Me.optSinFac.Location = New System.Drawing.Point(12, 12)
      Me.optSinFac.Name = "optSinFac"
      Me.optSinFac.Size = New System.Drawing.Size(28, 16)
      Me.optSinFac.TabIndex = 12
      ...
      ExplorerBarGroup1.ContainerHeight = 236
      ...
      Me.ebrMain.Size = New System.Drawing.Size(744, 268)
      ...
      Me.chkFecha.Location = New System.Drawing.Point(12, 334)
      ...
      Me.grpMain.Location = New System.Drawing.Point(4, 338)
      ...
      Me.UiGroupBox2.Location = New System.Drawing.Point(197, 338)
      Me.UiGroupBox2.Name = "UiGroupBox2"
      Me.UiGroupBox2.Size = New System.Drawing.Size(251, 72)
      ...
      Me.cboMoneda.Size = New System.Drawing.Size(160, 20)
      ...
      Me.cboTipoAsiento.Size = New System.Drawing.Size(160, 20)
      ...
      Me.KeyPreview = True
      Me.Name = "frmLibroDispoComparativoFind"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Criterios Disponibilidad Comparativo"
...
#End Region
   ...
   Private Sub frmLibroDispoFind_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmLibroDispoFind_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
...
#End Region
   ...
   Private Sub frmLibroDispoLoad()
      If FormCheck() Then
         ...
         Dim frm As New frmLibroDispoComparativo
         ...
         With frm
            ...
            .ListaEmpresas.Add(New Contabilidad.frmLibroDispoComparativo.EmpresaData(clsAppInfo.ConnectString, clsAppInfo.EmpresaId, clsAppInfo.GestionId, clsAppInfo.EmpresaDes, clsAppInfo.Gestion))
            For Each row In cboEmpresa.DropDownList.GetCheckedRows
               .ListaEmpresas.Add(New Contabilidad.frmLibroDispoComparativo.EmpresaData(ToStr(row.Cells("ConnectString").Value), ToLong(row.Cells("EmpresaId").Value), ToLong(row.Cells("GestionId").Value), ToStr(row.Cells("EmpresaDes").Value), ToLong(row.Cells("Gestion").Value)))
            Next
...
#End Region
   ...
   Public Overrides Function ToString() As String
      Return "Gestión: " & clsAppInfo.Gestion & If(chkFecha.Checked, " Desde " & dtpFechaIni.Text & " Hasta " & dtpFechaFin.Text, "") & "; Moneda: " & cboMoneda.Text & "; Tipo Asiento: " & cboTipoAsiento.Text & "; Incluir Saldo Anterior: " & If(chkSaldoAnterior.Checked, "Sí", "No")
   End Function
   ...
   Private Sub chkConsolidar_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkConsolidar.CheckedChanged
      If chkConsolidar.Checked Then
         Book1.Text = "Libro Consolidado"
         Me.Text = "Criterios Disponibilidad Consolidado"
      Else
         Book1.Text = "Libro Comparativo"
         Me.Text = "Criterios Disponibilidad Comparativo"
      End If
   End Sub
End Class
