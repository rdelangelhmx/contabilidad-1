...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.cdmMain.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New2, Me.Edit, Me.Delete, Me.ViewAll, Me.Print, Me.Exit2, Me.Check, Me.Refrescar})
      Me.cdmMain.ContainerControl = Me
      Me.cdmMain.Id = New System.Guid("4d9ad826-cfb9-4896-b57a-1665ca3ea7fb")
      ...
      Me.UiCommandBar1.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New1, Me.Separator1, Me.Edit1, Me.Separator2, Me.Delete1, Me.Separator3, Me.Check1, Me.Separator6, Me.Refrescar1, Me.Separator7, Me.ViewAll1, Me.Separator4, Me.Print1, Me.Separator5, Me.Exit1})
      ...
      Me.Check.ToolTipText = "Cambiar Empresa"
      '
      'Refrescar
      '
...
#End Region
   ...
   Private Sub grdMainLoad()
      Try
         With moEmpresa
            .SelectFilter = clsEmpresa.SelectFilters.Grid
            .WhereFilter = clsEmpresa.WhereFilters.Grid
            .OrderByFilter = clsEmpresa.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("EmpresaId")) > 0) Then
            With oEmpresa
               .EmpresaId = ToLong(grdMain.GetValue("EmpresaId"))

               If .FindByPK Then
                  Dim frm As New frmEmpresaEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oEmpresa
   ...
   Private Sub CloneVM(ByRef oVM As clsEmpresaVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            .EmpresaId = ToLong(grdMain.GetValue("EmpresaId"))
            .EmpresaDes = ToStr(grdMain.GetValue("EmpresaDes"))
   ...
   Private Sub DataDelete()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If Not CompFind(ToLong(grdMain.GetValue("EmpresaId"))) Then
               If Not NotaFind(ToLong(grdMain.GetValue("EmpresaId"))) Then
                  If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                     With oEmpresa
                        .WhereFilter = clsEmpresa.WhereFilters.PrimaryKey
                        .EmpresaId = ToLong(grdMain.GetValue("EmpresaId"))
                        ...
                        If .IsDeleted Then
                           ...
                           If .Delete Then
                              ...
                              Call PlanDelete(ToLong(grdMain.GetValue("EmpresaId")))
                              Call PlanEEFFDelete(ToLong(grdMain.GetValue("EmpresaId")))
                              Call EmpresaParaDelete(ToLong(grdMain.GetValue("EmpresaId")))
                              Call GestionDelete(ToLong(grdMain.GetValue("EmpresaId")))
                              Call CompParaDelete(ToLong(grdMain.GetValue("EmpresaId")))
                              Call ReciboParaDelete(ToLong(grdMain.GetValue("EmpresaId")))
                              Call NotaParaDelete(ToLong(grdMain.GetValue("EmpresaId")))
   ...
   Private Sub CambiarEmpresa()
      If grdMain.RowCount > 0 Then
         If MessageBox.Show("¿Esta Seguro que Quiere Utilizar la Empresa?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then

            Call modAuditoria.AudiOpeAdd(Me.Name, Me.Text, clsTipoOpera.CAMBIAR_EMPRESA, "Empresa Actual: " + clsAppInfo.EmpresaDes + " Empresa a Cambiar: " + grdMain.GetValue("EmpresaDes").ToString)

            clsAppInfo.EmpresaId = ToLong(grdMain.GetValue("EmpresaId"))
            clsAppInfo.GestionId = 0
            Call StatusGestionDisplay("")

            Dim strEmpresaAnt As String = clsAppInfo.EmpresaDes

            Call EmpresaParaLoad(clsAppInfo.EmpresaId)
            Call StatusEnterpriseDisplay(clsAppInfo.EmpresaDes)

            '*BITACORA Cambio de Empresa
            Call modAuditoria.AudiOpeAdd(Me.Name, Me.Text, clsTipoOpera.CAMBIAR_EMPRESA, "Empresa Anterior: " + strEmpresaAnt.ToString + " Empresa Actual: " + clsAppInfo.EmpresaDes.ToString)

            Dim frm As New frmGestionChange
            With frm
   ...
   Private Function NotaFind(ByVal lngEmpresaId As Long) As Boolean
      Dim oNota As New clsNota(clsAppInfo.ConnectString)

      Try
         With oNota
            .SelectFilter = clsNota.SelectFilters.ListBox
            .WhereFilter = clsNota.WhereFilters.EmpresaId
   ...
   Private Function CompFind(ByVal lngEmpresaId As Long) As Boolean
      Dim oComp As New clsComp(clsAppInfo.ConnectString)

      Try
         With oComp
            .SelectFilter = clsComp.SelectFilters.ListBox
            .WhereFilter = clsComp.WhereFilters.EmpresaId
            .EmpresaId = lngEmpresaId
   ...
   Private Function PlanDelete(ByVal lngEmpresaId As Long) As Boolean
   ...
   Private Function PlanEEFFDelete(ByVal lngEmpresaId As Long) As Boolean
      Dim oPlanEEFF As New clsPlanEEFF(clsAppInfo.ConnectString)

      PlanEEFFDelete = False

      Try
         With oPlanEEFF
            .WhereFilter = clsPlanEEFF.WhereFilters.EmpresaId
            .EmpresaId = lngEmpresaId
   ...
   Private Function EmpresaParaDelete(ByVal lngEmpresaId As Long) As Boolean
      Dim oEmpresaPara As New clsEmpresaPara(clsAppInfo.ConnectString)

      EmpresaParaDelete = False
   ...
   Private Function GestionDelete(ByVal lngEmpresaId As Long) As Boolean
   ...
   Private Function CompParaDelete(ByVal lngEmpresaId As Long) As Boolean
      ...
      Try
         With oCompPara
            .WhereFilter = clsCompPara.WhereFilters.EmpresaId
            .EmpresaId = lngEmpresaId
   ...
   Private Function ReciboParaDelete(ByVal lngEmpresaId As Long) As Boolean
      ...
      Try
         With oReciboPara
            .WhereFilter = clsReciboPara.WhereFilters.EmpresaId
            .EmpresaId = lngEmpresaId
   ...
   Private Function NotaParaDelete(ByVal lngEmpresaId As Long) As Boolean
      ...
      Try
         With oNotaPara
            .WhereFilter = clsNotaPara.WhereFilters.EmpresaId
            .EmpresaId = lngEmpresaId
   ...
   Private Sub PrintReport()
      Dim rpt As New rptEmpresa

      rpt.DataSource = GetDataView(moEmpresa.DataSet.Tables(moEmpresa.TableName))

      rpt.lblTitle.Text = "Empresas"
      rpt.Document.Name = "Empresas"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("EmpresaId")
   ...
   Private Sub FormInit()
      ...
      moEmpresa = New clsEmpresa(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Empresas"
         .ContextMenu = mnuMain
         ...
         '.FrozenColumns = 2
         '.RootTable.Columns("EmpresaDes").Selectable = False

         .RootTable.Columns("EmpresaRUC").Caption = "NIT"
         .RootTable.Columns("EmpresaRUC").Width = 100
         .RootTable.Columns("EmpresaRUC").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("EmpresaRUC").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         ...
         .RootTable.Columns("Movil").Width = 200
         ...
         .RootTable.Columns("CodPostal").Caption = "Cod. Postal"
         .RootTable.Columns("CodPostal").Width = 100
         .RootTable.Columns("CodPostal").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("CodPostal").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("Email").Caption = "Correo"
         ...
         .RootTable.Columns("MesAperturaId").Visible = False

         .RootTable.Columns("MesAperturaDes").Caption = "Mes Apertura"
         .RootTable.Columns("MesAperturaDes").Width = 100
         .RootTable.Columns("MesAperturaDes").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("MesAperturaDes").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("MesCierreId").Visible = False

         .RootTable.Columns("MesCierreDes").Caption = "Mes Cierre"
         .RootTable.Columns("MesCierreDes").Width = 100
         .RootTable.Columns("MesCierreDes").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("MesCierreDes").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
   ...
   Private Sub AddConditionalFormatting()
      ...
      fc = New Janus.Windows.GridEX.GridEXFormatCondition(grdMain.RootTable.Columns("EmpresaId"), Janus.Windows.GridEX.ConditionOperator.Equal, clsAppInfo.EmpresaId)
   ...
   Private Sub frmEmpresa_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmEmpresa_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moEmpresa.Dispose()
      Call ClearMemory()
   End Sub
