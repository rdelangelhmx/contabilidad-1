Public Class frmBalanceComparativo
   ...
   Private mdecResultadoBs As Decimal
   ...
   Private mdecResultadoUs As Decimal
...
#Region " Set and Get "
   ...
   Property FechaIniOri() As Date
      Get
         Return mdatFechaIniOri
      End Get

      Set(ByVal Value As Date)
         mdatFechaIniOri = Value
      End Set
   End Property

   Property FechaFinOri() As Date
      Get
         Return mdatFechaFinOri
      End Get

      Set(ByVal Value As Date)
         mdatFechaFinOri = Value
      End Set
   End Property
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmBalanceComparativo))
      ...
      Me.UiCommandBar1.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.Book1, Me.Separator1, Me.ViewAll1, Me.Separator2, Me.VerListadoObs1, Me.Separator4, Me.Print1, Me.Separator5, Me.ExportToExcel1, Me.Separator3, Me.Exit1})
      ...
      Me.KeyPreview = True
      Me.Name = "frmBalanceComparativo"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Balance General Comparativo"
...
#End Region
   ...
   Private Sub FormInit()
      ...
      mdatFechaIniOri = mdatFechaIni
      mdatFechaFinOri = mdatFechaFin
   ...
   Private Sub PrintReport()
      Dim rpt As New rptBalanceComparativo
      Dim strMonedaSigla As String

      rpt.DataSource = GetDataView(moDataTable.DataSet.Tables(moPlan.TableName))

      rpt.lblTitle.Text = "Balance General Comparativo"
      rpt.Document.Name = "Balance General Comparativo"
      rpt.lblCompany.Text = clsAppInfo.EmpresaGral
      rpt.lblDate.Text = "Fecha: " + Format(Now(), "Long Date")
      rpt.lblTime.Text = "Hora: " + Format(Now(), "Long Time")
      rpt.lblLogin.Text = "Usuario: " + clsAppInfo.LoginId
      rpt.txtFechaFin.Text = Format(CDate(ToDateDMY(mdatFechaFin)), "dd ' de ' MMMM ' del ' yyyy")
   ...
   Private Sub frmBalanceComparativo_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moPlan.Dispose()
      Call ClearMemory()
   End Sub
...
#Region " Grid-Balance "
         ...
         With oGestion
            ...
            If .FindByPK Then
               ...
               If mdatFechaFinOri.Day = 29 And mdatFechaFinOri.Month = 2 Then
                  Dim lngyear = mdatFechaIni.Year + Math.Abs(mdatFechaIniOri.Year - mdatFechaFinOri.Year)
               ...
               Dim datFechaFinAux = New Date(mdatFechaIni.Year + Math.Abs(mdatFechaIniOri.Year - mdatFechaFinOri.Year), mdatFechaFinOri.Month, lngDiaFin)
               mdatFechaFin = datFechaFinAux
            End If
         End With
   ...
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Balance General Comparativo"
         ...
         'CS.Add(.RootTable.Columns("PlanCtaAux"), 0, 2)
         ...
         ElseIf mlngMonedaId = 4 Then
            ...
            CS2.Caption = "Totales"
            CS2.Add(.RootTable.Columns("TotalBs"), 0, 0) '; // First parameter is GridEXColumn, Second is row in ColumnSet, third is col
            CS2.Add(.RootTable.Columns("TotalUs"), 0, 1) '; // First parameter is GridEXColumn, Second is row in ColumnSet, third is col
         End If

         .RootTable.Columns("TotalBs").Caption = "Total Bs"
         ...
         .RootTable.Columns("TotalUs").Caption = "Total Us"
   ...
   Private Sub frmBalanceComparativo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
#Region "otro prueba"
   ...
   Private Function AddRowDataTableEmpresas(ByVal oDataRow As DataRow, ByVal strTab As String) As Long
      ...
      If ToLong(oDataRow("TipoGrupoId")) = 1 Or ToLong(oDataRow("TipoGrupoId")) = 2 Or ToLong(oDataRow("TipoGrupoId")) = 3 Then
         ...
         If ToBoolean(oDataRow("TieneAnaAdd")) And mboolIncluirPlanAdd Then
   ...
   Private Sub UpdateRowDataTableEmpresas(ByVal lngIndex As Long, ByVal oDataRowCuenta As DataRow)
      ...
      If ToBoolean(oDataRowCuenta("EsAna")) Then
         ...
         If datatableCompDet IsNot Nothing Then
            ...
            Dim strFiltro As String = "Fecha >= '" & ToDateDMY(mdatFechaIni) & "' and Fecha <= '" & ToDateDMY(mdatFechaFin) & "'"
...
#End Region
   ...
   Private Sub GetResultado()
      ...
      If moDataTable.Select("Id = " & 11).Length > 0 Then
         oRow = moDataTable.Select("Id = " & 11).Last
      Else
         oRow = moDataTable.NewRow
         oRow("Id") = 11
      ...
      mdecResultadoBs = EstadoResultadoBs(mdecResultadoUs)
      oRow("GralBsDet" & mlngpos) = mdecResultadoBs
      oRow("GralUsDet" & mlngpos) = mdecResultadoUs
   End Sub

   Private Function EstadoResultadoBs(ByRef decResultadoUs As Decimal) As Decimal
      Dim datatableCompDet As DataTable
      Dim oPlan As New clsPlan(mstrConnectString)
   ...
   Private Sub addBalance()
      ...
      If moDataTable.Select("Id = " & 12).Length > 0 Then
         oRow = moDataTable.Select("Id = " & 12).Last
      Else
         oRow = moDataTable.NewRow
         oRow("Id") = 12
      ...
      For Each row In moDataTable.Rows
         If ToLong(row("PlanPadreId" & mlngpos)) = 0 And (ToStr(row("PlanCta")).Equals("2") _
         Or ToStr(row("PlanCta")).Equals("3")) Then
            oRow("GralBsDet" & mlngpos) = ToDecimal(oRow("GralBsDet" & mlngpos)) + ToDecimal(row("GralBsDet" & mlngpos))
            oRow("GralUsDet" & mlngpos) = ToDecimal(oRow("GralUsDet" & mlngpos)) + ToDecimal(row("GralUsDet" & mlngpos))
         End If
      Next
      oRow("GralBsDet" & mlngpos) = mdecResultadoBs + ToDecimal(oRow("GralBsDet" & mlngpos))
      oRow("GralUsDet" & mlngpos) = mdecResultadoUs + ToDecimal(oRow("GralUsDet" & mlngpos))
   ...
   Private Sub GetOrdenDeudora()
      ...
      If moDataTable.Select("Id = " & 13).Length > 0 Then
         oRow = moDataTable.Select("Id = " & 13).Last
      Else
         oRow = moDataTable.NewRow
         oRow("Id") = 13
      ...
      End If
      oRow("GralBsDet" & mlngpos) = OrdenDeudoraBs(decOrdenDeudorUs)
      oRow("GralUsDet" & mlngpos) = decOrdenDeudorUs
   End Sub
   ...
   Private Sub GetOrdenAcreedora()
      ...
      If moDataTable.Select("Id = " & 14).Length > 0 Then
         oRow = moDataTable.Select("Id = " & 14).Last
      Else
         oRow = moDataTable.NewRow
         oRow("Id") = 14
      ...
      End If
      oRow("GralBsDet" & mlngpos) = OrdenAcreedoraBs(decOrdenAcreedoraUs)
      oRow("GralUsDet" & mlngpos) = decOrdenAcreedoraUs
   End Sub

   Private Function OrdenDeudoraBs(ByRef decOrdenDeudoraUs As Decimal) As Decimal
      Dim datatableCompDet As DataTable
      Dim oPlan As New clsPlan(mstrConnectString)
      Dim lngGrupo As Long
      Dim decHaberBs As Decimal
   ...
   Private Function OrdenAcreedoraBs(ByRef decOrdenAcreedoraUs As Decimal) As Decimal
      Dim datatableCompDet As DataTable
      Dim oPlan As New clsPlan(mstrConnectString)
      Dim lngGrupo As Long
      Dim decHaberBs As Decimal
