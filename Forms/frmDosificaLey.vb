...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmDosificaLey))
      ...
      Me.KeyPreview = True
      Me.Name = "frmDosificaLey"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = " Leyendas de Derechos del Consumidor"
...
#End Region
   ...
   Private Sub frmDosificaLey_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmDosificaLey_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moDosificaLey
            .SelectFilter = clsDosificaLey.SelectFilters.Grid
            .OrderByFilter = clsDosificaLey.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("DosificaLeyId")) > 0) Then
            With oDosificaLey
               .DosificaLeyId = ToLong(grdMain.GetValue("DosificaLeyId"))

               If .FindByPK Then
                  Dim frm As New frmDosificaLeyEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oDosificaLey
   ...
   Private Sub CloneVM(ByRef oVM As clsDosificaLeyVM)
      If clsAppInfo.RegistrarBitacora Then
         ...
         With oVM
            .DosificaLeyId = ToLong(grdMain.GetValue("DosificaLeyId"))
            .DosificaLeyDes = ToStr(grdMain.GetValue("DosificaLeyDes"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oDosificaLey
                  .WhereFilter = clsDosificaLey.WhereFilters.PrimaryKey
                  .DosificaLeyId = ToLong(grdMain.GetValue("DosificaLeyId"))
   ...
   Private Sub PrintReport()
      'Dim rpt As New rptPlanDescuento

      'rpt.DataSource = GetDataView(moDosificaLey.DataSet.Tables(moDosificaLey.TableName))

      'rpt.lblTitle.Text = "DosificaLeys"
      'rpt.Document.Name = "DosificaLeys"
      'rpt.lblPlanDescuentoDes.Text = "DosificaLey"
      'rpt.txtPlanDescuentoDes.DataField = "DosificaLeyDes"

      'rpt.lblPlanDes.Text = " "
      'rpt.txtPlanDes.DataField = " "
      'rpt.txtPlanDes.Visible = False
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("DosificaLeyId")
   ...
   Private Sub FormInit()
      ...
      moDosificaLey = New clsDosificaLey(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Leyendas de Derechos del Consumidor"
         .ContextMenu = mnuMain

         .RootTable.Columns("DosificaLeyId").Visible = False

         .RootTable.Columns("DosificaLeyDes").Caption = "Leyenda"
         .RootTable.Columns("DosificaLeyDes").Width = 500
   ...
   Private Sub frmDosificaLey_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmDosificaLey_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
